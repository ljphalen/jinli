...
class Client_SubjectController extends Admin_BaseController {
	...
	public function add_postAction() {
		$info = $this->getPost(array('sort', 'title','resume', 'icon', 'img', 'hot', 'start_time', 'end_time', 'status', 'hits'));
	...
	public function edit_postAction() {
		$info = $this->getPost(array('id', 'sort', 'title','resume', 'icon', 'img', 'hot', 'start_time', 'end_time', 'status', 'hits'));
		$info = $this->_cookData($info);
