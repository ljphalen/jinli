 ...
 *
 */
class LocalgameController extends Admin_BaseController {
	
	public $actions = array(
		'listUrl' => '/Admin/Localgame/index',
		'addUrl' => '/Admin/Localgame/add',
		'addPostUrl' => '/Admin/Localgame/add_post',
		'editUrl' => '/Admin/Localgame/edit',
		'editPostUrl' => '/Admin/Localgame/edit_post',
		'deleteUrl' => '/Admin/Localgame/delete',
		'deleteImgUrl' => '/Admin/Localgame/delete_img',
		'uploadUrl' => '/Admin/Localgame/upload',
		'uploadPostUrl' => '/Admin/Localgame/upload_post',
		'step1Url' => '/Admin/Localgame/add_step1',
		'step2Url' => '/Admin/Localgame/add_step2'
	);
	...
	public function indexAction() {
		...
		list($total, $games) = Game_Service_Game::getCanUseGames($page, $perpage, $params);
	...
	public function add_step1Action() {
		...
		//get games list
		$gameApi  = new Api_Game_Service();
		$games = $gameApi->getList($page, $this->perpage, array('name'=>$name));
		$this->assign('games', $games);
		$this->assign('keyword', $name);
	
		$url = $this->actions['step1Url'] .'/?'. http_build_query(array('keyword'=>$name)) . '&';
	...
	public function add_step2Action() {
		$id = $this->getInput('id');
		$gameApi  = new Api_Game_Service();
		$info = $gameApi->getResourceGames(intval($id));
		$this->assign('info', $info);
	...
	public function add_postAction() {
		$info = $this->getPost(array('sort', 'name', 'category_id', 'title','language','price', 'version', 'recommend','link', 'img', 'company', 'size', 'hits', 'status','descrip', 'create_time'));
	...
	public function edit_postAction() {
		$info = $this->getPost(array('id', 'sort', 'name', 'category_id', 'title','language','price', 'version', 'recommend', 'link', 'img', 'company', 'size', 'hits', 'status','descrip', 'create_time'));
		//修改的图片
		$info['create_time'] = Common::getTime();
