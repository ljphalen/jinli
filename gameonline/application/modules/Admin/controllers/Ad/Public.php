 ...
 *
 */
class Ad_PublicController extends Admin_BaseController {
	
	public $actions = array(
		'listUrl' => '/Admin/Ad_Public/index',
		'addUrl' => '/Admin/Ad_Public/add',
		'addPostUrl' => '/Admin/Ad_Public/add_post',
		'editUrl' => '/Admin/Ad_Public/edit',
		'editPostUrl' => '/Admin/Ad_Public/edit_post',
		'deleteUrl' => '/Admin/Ad_Public/delete',
		'uploadUrl' => '/Admin/Ad_Public/upload',
		'uploadPostUrl' => '/Admin/Ad_Public/upload_post',
	);
	...
	public function indexAction() {
		...
		$ad_ltype = intval($this->getInput('ad_ltype'));
		...
		if($ad_ltype) {
			$search['ad_ltype'] = $ad_ltype;
			$params['ad_ltype'] = $ad_ltype;
		}
	...
	public function add_postAction() {
		$info = $this->getPost(array('sort', 'title', 'ad_type', 'ad_ptype','link', 'img', 'start_time', 'end_time', 'status','ad_ltype'));
	...
	public function edit_postAction() {
		$info = $this->getPost(array('id', 'sort', 'title', 'ad_type', 'ad_ptype','link', 'img', 'start_time', 'end_time', 'status','ad_ltype'));
		$info = $this->_cookData($info);
		$info['ad_type'] = $this->ad_type;
