 ...
 *
 */
class WebController extends Kingstone_BaseController{
	
	public $actions = array(
		'listUrl' => '/kingstone/web/index',
    ...
    public function indexAction() {
		...
		list(, $ad) = Client_Service_Ad::getCanUseNormalAds(1, 1, array('ad_type'=>1,'status'=>1,'hits'=>2));
