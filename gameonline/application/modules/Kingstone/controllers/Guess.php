 ...
 *
 */
class GuessController extends Kingstone_BaseController{
	
	public $actions = array(
		'listUrl' => '/kingstone/guess/index',
	...
	public function moreAction(){
		...
		//get games list
		//list($total, $games) = Client_Service_Guess::getList($page, $this->perpage, $params, array('id'=>'DESC'));
		$gues = Client_Service_Guess::getGamesByImCrc( $imei );
		$ids = explode(',',$gues['game_ids']);
	    if($gues){
