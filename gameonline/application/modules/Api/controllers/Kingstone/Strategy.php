...
class Kingstone_StrategyController extends Api_BaseController {
	
	public $actions =array(
				'index' => '/kingstone/strategy/index',
				'detailUrl' => '/kingstone/index/detail/',
			    'styDetailUrl' => '/kingstone/strategy/detail/',
	...
	public function indexAction() {
		...
		foreach($strategys as $key=>$value) {
			...
			$href = urldecode($webroot.$this->actions['styDetailUrl']. '?id=' . $value['id'].'&intersrc='.$intersrc.'&t_bi='.$this->getSource().'&sp='.$sp);
