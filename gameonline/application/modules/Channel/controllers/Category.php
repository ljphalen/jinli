...
class CategoryController extends Channel_BaseController{
	...
	public function indexAction() {
		...
		foreach($categorys as $key=>$value) {
			$categorys[$key]['game_title'] = Resource_Service_Attribute::getGameData($value['id'],$sp, $this->filter);
		}
	...
	public function moreAction() {
		...
		foreach($categorys as $key=>$value) {
			...
			$temp[$key]['game_title'] = Resource_Service_Attribute::getGameData($value['id'], $sp, $this->filter);
		}
