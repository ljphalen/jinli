...
$type = (stristr($staticroot,'ala') ? 'channel':'apk');
...
$config = array(
	'Client_Index_index'=>array(
			'CACHE'=>array(
					$staticroot . '/??/sys/reset/phonecore.css,/apps/game/apk/assets/css/game.css'.$old_css.'?v=' . $v,
					$staticroot . '/sys/icat/'.$icat.'/icat.js?v=' . $v,
					$staticroot . '/apps/game/apk/assets/js/main.js?v=' . $v,
					$staticroot . '/??/apps/game/apk/assets/js/plugin/cordova-2.0.0.js,/sys/lib/jquery/jquery.js,/apps/game/apk/assets/js/game.js?v=' . $v,
					$staticroot . '/??/sys/icat/'.$icat.'/mvc.js,apps/game/apk/assets/js/mvc/view.js,/apps/game/apk/assets/js/mvc/model.js,/apps/game/apk/assets/js/mvc/controller.js?v=' . $v,
	...
	'Client_Category_index'=>array(
			'CACHE'=>array(
					...
					$staticroot . '/??/apps/game/apk/assets/js/plugin/cordova-2.0.0.js,/sys/lib/jquery/jquery.js,/apps/game/apk/assets/js/game.js?v=' . $v,
					$staticroot . '/??/sys/icat/'.$icat.'/mvc.js,apps/game/apk/assets/js/mvc/view.js,/apps/game/apk/assets/js/mvc/model.js,/apps/game/apk/assets/js/mvc/controller.js?v=' . $v,
					$staticroot . '/apps/game/apk/assets/js/game.js?v=' . $v,
					$staticroot . '/apps/game/apk/pic/blank.gif',
					$staticroot . '/apps/game/apk/assets/img/default_bg.png'
			),
			'NETWORK'=>array('*'),
