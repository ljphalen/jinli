...
class Client_Service_Tuijian{
	...
	public static function getAllSortTuijian() {
		return self::_getDao()->getAllSortTuijian();
	}
	...
	public static function getCanUseTuijian($page, $limit, $params = array()) {
		...
		$start = ($page - 1) * $limit;
		$ret = self::_getDao()->getCanUseTuijians(intval($start), intval($limit), $params);
		$total = self::_getDao()->getCanUseTuijianCount($params);
		return array($total, $ret);
	}
	...
	public static function getTuijiansByNId($n_id) {
		...
		return self::_getDao()->getTuijiansByNId($n_id);
	}
	...
	public static function updateTuijianStatus($ids,$status) {
		return self::_getDao()->updateTuijianStatus($ids, $status);
	}
