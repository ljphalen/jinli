...
class Client_Service_Besttj{
	 ...
	 * @param unknown_type $data
	 */
	public static function batchAddByBesttj($data,$id) {
		$tmp = array();
		...
		return self::_getBesttjDao()->mutiInsert($tmp);
	}
	...
	public static function updateBesttjByBesttjId($besttj_id,$status) {
		if (!$besttj_id) return false;
		return self::_getBesttjDao()->updateBesttjByBesttjId(intval($besttj_id),$status);
	}
	...
	public static function getIdxBesttjByOnlineBesttjId($besttj_id) {
		if (!$besttj_id) return false;
		return self::_getBesttjDao()->getsBy(array('besttj_id'=>intval($besttj_id),'status'=>1), array('sort'=>'DESC','game_id'=>'DESC'));
	}
	...
	public static function getIdxBesttjByGameBesttjId($game_id,$besttj_id) {
		if (!$game_id) return false;
		return self::_getBesttjDao()->getBy(array('game_id'=>$game_id,'besttj_id'=>$id));
	}
	...
	public static function updateIdxBesttjStatus($game_id,$status) {
		if (!$game_id) return false;
		 self::_getBesttjDao()->updateIdxBesttjStatus($game_id,$status);
		 self::updateByBesttjTmps(array('game_status'=>$status),array('game_id'=>$game_id));
		 return true;
	}
	...
	public static function getIdxGameBesttjs() {
		return self::_getBesttjDao()->getAllByGameStatus();
	}
