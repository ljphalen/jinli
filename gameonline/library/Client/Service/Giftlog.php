...
class Client_Service_Giftlog{
	...
	public static function getByActivationCode($activation_code) {
		...
		return self::_getDao()->getBy(array('activation_code'=>$activation_code));
	}
	...
	public static function getsByGiftId($gift_id) {
		if (!intval($gift_id)) return false;
		return self::_getDao()->getsBy(array('gift_id'=>$gift_id));
	}
	...
	public static function getByImeiGiftId($imei,$gift_id) {
		...
		return self::_getDao()->getBy(array('imeicrc'=>$imei,'gift_id'=>$gift_id), array('create_time'=>'DESC'));
	}
	...
	public static function getByUnameGiftId($uname,$gift_id) {
		...
		return self::_getDao()->getBy(array('uname'=>$uname,'gift_id'=>$gift_id), array('create_time'=>'DESC'));
	}
	...
	public static function getGiftlogByStatus($status,$gift_id) {
		return self::_getDao()->count(array('status'=>$status,'gift_id'=>$gift_id));
	}
	...
	public static function getGiftlogCount($gift_id) {
		return self::_getDao()->count(array('gift_id'=>$gift_id));
	}
	...
	public static function getGiftlogByGameID($game_id) {
		return self::_getDao()->getsBy(array('game_id'=>$game_id));
	}
	...
	public static function updateImeiGiftId($imei,$id) {
		...
		$time = Common::getTime();
		return self::_getDao()->update(array('imei'=>$imei, 'imeicrc'=>crc32($imei),'create_time'=>$time,'status'=>1),$id);
	}
	...
	public static function updateGiftLogGameId($old_game_id,$new_game_id,$gift_id) {
		...
		return self::_getDao()->updateBy(array('game_id'=>intval($new_game_id)), array('game_id'=>intval($old_game_id),'gift_id'=>$gift_id));
	}
	...
	public static function deleteGiftlogByActivationCcode($activation_code) {
		return self::_getDao()->deleteBy(array('activation_code'=>$activation_code));
	}
