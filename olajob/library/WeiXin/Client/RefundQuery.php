 ...
 * 退款查询接口
 */
class WeiXin_Client_RefundQuery extends WeiXin_Client_Base
{
    ...
    function createXml()
    {
        try
        {
            ...
            {
                throw new WeiXin_Error("退款查询接口中，out_refund_no、out_trade_no、transaction_id、refund_id四个参数必填一个！"."<br>");
            }
