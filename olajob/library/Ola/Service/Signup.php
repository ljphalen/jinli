 ...
 *
 */
class Ola_Service_Signup extends Common_Service_Base{
     ...
     */
    public static function status($key=0) {
        $status = array(
            1 => '已拒绝',
            2 => '待审核',
            3 => '已通过',
        );
        return $key ? $status[intval($key)] : $status;
    }
	
	/**
	 * 
	 * @return Ola_Dao_Signup
	 */
	private static function _getDao() {
		return Common::getDao("Ola_Dao_Signup");
	}
}
