var App = function () {
    ...
    var handleStyler = function () {
        //动态加载jquery.cookie插件
        $(function(){
            jQuery.getScript('/admin/js/jquery.cookie.js',function(){
                ...
                jQuery('#theme-change .colors span').click(function () {
                    ...
                    setColor(color);
                    jQuery.cookie('skins',color,{domain:'gionee.com',path:'/'});
                    //临时支持IP Cookie
                    jQuery.cookie('skins',color,{domain:'18.8.10.194',path:'/'});
                });
                ...
                var setColor = function (color) {
                    $('#style_color').attr("href", "/admin/css/style_" + color + ".css");
                }

                var setSkins = function(color){
                    $('head:eq(0)').append('<link href="/admin/css/style_' + color + '.css" rel="stylesheet" />');
                }

                

/*                if(jQuery.cookie('skins')){
                    setColor(jQuery.cookie('skins'));
                } else {
                    setColor('default');
                }*/
    ...
    var handleTables = function () {
        ...
        $('#sample_1').dataTable({
            ...
            "oLanguage": {
                "sLengthMenu": "每页显示的条数：_MENU_",
                "sSearch": "搜索：",
                "sInfo": "共 _TOTAL_ 条记录 当前第(_START_ - _END_)条",
                "oPaginate": {
                    "sPrevious": "上一页",
                    "sNext": "下一页"
                }
