...
define("cordova/plugin/gntheme", function(require, exports, module) {
var exec = require('cordova/exec');
...
module.exports = {
     ...
     */
    startlistctivity: function(successCallback, errorCallback, options) {
	var listurl = null;
        if (options && typeof options.listurl == "string") {
        	listurl = options.listurl;
        }
	var topicTheme = null;
        if (options && typeof options.topicTheme == "string") {
        	topicTheme = options.topicTheme;
        }

	exec(successCallback, errorCallback, "NetThemePlugin", "startlistactivity", [listurl,topicTheme]);
    },
    /**
     * startaprectivity
     * @param  {[type]} successCallback [description]
     ...
     * @return {[type]}                 [description]
     */
    startaprectivity: function(successCallback, errorCallback, options) {
        ...
        var titleTheme = null;
        if (options && typeof options.titleTheme == "string") {
            titleTheme =  options.titleTheme;
        }

        var preurl = null;//load webview url
        if (options && typeof options.preurl == "string") {
            preurl = options.preurl;
        }

	var dlurl = null;//download url
        if (options && typeof options.dlurl == "string") {
            dlurl = options.dlurl;
        }
	var pre = null;
	if (options && typeof options.pre == "string"){
	    pre = options.pre
	}
	var next = null;
	if (options && typeof options.next == "string"){
	    next = options.next
	}
        // Get info
        exec(successCallback, errorCallback, "NetThemePlugin", "startpreactivity", [idTheme,titleTheme,preurl,dlurl,pre,next]);
    },
     /*
      *reloadpretheme : realod PreThemeActivity WebView url
      *
      */
    reloadpretheme: function(successCallback, errorCallback, options){
	...
	if (options && typeof options.next == "string"){
        ...
        // Get info
        exec(successCallback, errorCallback, "NetThemePlugin", "reloadpretheme", [idTheme,titleTheme,preurl,dlurl,pre,next]);

    },
      /*
      *getconnectiontheme : getConnection state
      *
      */
	getconnectiontheme: function(successCallback, errorCallback, options){ 
 
         exec(successCallback, errorCallback, "NetThemePlugin", "getconnectioninfo", []);

    },

    fullScreenPre:function(successCallback, errorCallback, options){

        if (options && typeof options.imgurl == "string"){
            imgurl = options.imgurl
        }
        if (options && typeof options.themeid == "string"){
            themeid = options.themeid
        }
        if (options && typeof options.imageid == "string"){
            imageid = options.imageid
        }

        exec(successCallback, errorCallback, "NetThemePlugin", "FullScreenPre", [imgurl, themeid, imageid]);
    }
};
});
