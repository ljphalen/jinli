 ...
 *
 */
class GntaobaourlController extends Admin_BaseController {
	
	public $actions = array(
		'listUrl' => '/Admin/GnTaobaourl/index',
		'addUrl' => '/Admin/GnTaobaourl/add',
		'addPostUrl' => '/Admin/GnTaobaourl/add_post',
		'editUrl' => '/Admin/GnTaobaourl/edit',
		'editPostUrl' => '/Admin/GnTaobaourl/edit_post',
		'deleteUrl' => '/Admin/GnTaobaourl/delete',
	);
	...
	public function indexAction() {
	    ...
	    list($total, $suppliers) = Gou_Service_Taobaourl::getList($page, $perpage,array('channel'=>1));
