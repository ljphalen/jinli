...
class Gc_Service_Subject{
	 ...
	 * Enter description here ...
	 */
	public static function getAllSubjectSort() {
		return array(self::_getDao()->getAllSubjectSortCount(), self::_getDao()->getAllSubjectSort());
	}
	...
	/**
	 * 
	 * @return Gc_Dao_Subject
	 */
	private static function _getDao() {
		return Common::getDao("Gc_Dao_Subject");
	}
}
