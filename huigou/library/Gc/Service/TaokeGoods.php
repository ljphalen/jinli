...
class Gc_Service_TaokeGoods{
	 ...
	 * @param int $id
	 */
	public static function getCountBySubjectId() {
		return self::_getDao()->getCountBySubjectId();
	}
	...
	/**
	 *
	 * get goods info by num_iid
	 * @param int $id
	 */
	public static function getGoodsByNum_iids($id) {
		if (!intval($id)) return false;
		return self::_getDao()->get(intval($id));
	}
	...
	public static function want(array $data) {
		if (!is_array($data)) return false;
		$ret = Gc_Service_User::want($data['uid']);
		if (!$ret) return false;
		$ret = Gc_Service_WantLog::addWantLog($data);
		if (!$ret) return false;
	...
	private static function _cookData($data) {
		...
		if(isset($data['label_id'])) $tmp['label_id'] = intval($data['label_id']);
	...
	/**
	 * 
	 * @return Gc_Dao_TaokeGoods
	 */
	private static function _getDao() {
		return Common::getDao("Gc_Dao_TaokeGoods");
	}
}
