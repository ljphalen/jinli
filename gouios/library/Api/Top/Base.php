...
class Api_Top_Base extends Api_Top_Client {
	...
	public function getTaobaokeItems($nick, array $params) {
		...
		$params = array_merge(
			$params,
			array(
				'fields' => 'num_iid,title,nick,pic_url,price,click_url,commission,commission_rate,commission_num,commission_volume,mall_click_url,seller_credit_score,item_location,volume',
				'nick' => $nick
			)
		);
