 ...
 *
 */
class Gionee_Service_Browserseries {
	...
	private static function _cookData($data) {
		$fields = array('id', 'name', 'value', 'brand_id', 'created_at');
		return Common::cookData($data, $fields);
	}

	/**
	 *
	 * @return Gionee_Dao_Browserseries
	 */
	private static function _getDao() {
		return Common::getDao("Gionee_Dao_Browserseries");
	}
}