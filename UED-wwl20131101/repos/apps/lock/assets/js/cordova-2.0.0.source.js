...
module.exports = {
    ...
    var topicLockScreen = null;
        if (options && typeof options.topicLockScreen == "string") {
            topicLockScreen = options.topicLockScreen;
        }

    exec(successCallback, errorCallback, "NetLockScreenPlugin", "startlistactivity", [listurl,topicLockScreen]);
    },
    /**
     * startaprectivity
     * @param  {[type]} successCallback [description]
     ...
     * @return {[type]}                 [description]
     */
    startpreactivity: function(successCallback, errorCallback, options){

        var titleLockScreen = null;
        if (options && typeof options.titleLockScreen == "string") {
            titleLockScreen =  options.titleLockScreen;
        }
        ...
        // Get info
        exec(successCallback, errorCallback, "NetLockScreenPlugin", "startpreactivity", [titleLockScreen,preurl,dlurl]);
    },
    ...
    getconnectiontheme: function(successCallback, errorCallback, options){ 
         ...
         exec(successCallback, errorCallback, "NetLockScreenPlugin", "getconnectioninfo", []);
