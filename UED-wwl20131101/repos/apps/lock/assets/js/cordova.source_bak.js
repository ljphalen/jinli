...
module.exports = {
    ...
    downloadStart: function(successCallback, errorCallback, options) {
        ...
        console.log("downloadStart lockScreenJSON = " + lockScreenJSON);
        exec(successCallback, errorCallback, "GnLockScreenPlugin", "downloadStart", [lockScreenJSON]);
    },
    ...
    downloadContinue: function(successCallback, errorCallback, options) {
        ...
        console.log("downloadContinue lockscreenId = " + lockscreenId);
        exec(successCallback, errorCallback, "GnLockScreenPlugin", "downloadContinue", [lockscreenId]);
    },
    ...
    downloadWatch: function(successCallback, errorCallback, options) {
        // successCallback required
        if (typeof successCallback != "function") {
            navigator.gnLockScreen.gnLog("downloadWatch Error: successCallback is not a function");
            return;
        }

        // errorCallback optional
        if (errorCallback && (typeof errorCallback != "function")) {
            navigator.gnLockScreen.gnLog("downloadWatch Error: errorCallback is not a function");
            return;
        }
        ...
        console.log("downloadWatch lockscreenId = " + lockscreenId);
        exec(successCallback, errorCallback, "GnLockScreenPlugin", "downloadWatch", [lockscreenId]);
    },
