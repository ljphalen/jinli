...
module.exports = {
    ...
    startlistactivity: function(successCallback, errorCallback, options) {
        ...
        var newArgs = null;
        if (options && typeof options.newArgs == "object") {
            newArgs =  options.newArgs;
        }
        // alert(title+","+url+","+newArgs.title+","+newArgs.url);
	exec(successCallback, errorCallback, "GNGameHallPlugin", "startlistactivity", [title,url,newArgs]);
    },
    /**
    ...
    startdetailsactivity: function(successCallback, errorCallback, options) {
        ...
        var newArgs=null;
	       ...
	       // alert("detail:viewType:"+newArgs.viewType+" param:"+newArgs.param);
        // Get info
        exec(successCallback, errorCallback, "GNGameHallPlugin", "startdetailsactivity", [title,url,gameid,downurl,packagename,filesize,sdkinfo,resolution,newArgs]);
    },
     /*
    ...
    startlocalbrowser:function(successCallback,errorCallback,options){
        options=JSON.parse(options);
        var obj=null;
        if(options && typeof options=='object'){
            obj=options;
        }
        exec(successCallback, errorCallback, "GNGameHallPlugin", "startlocalbrowser", [obj]);   
    }
};
});
