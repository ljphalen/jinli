...
abstract class Common_BaseController extends Yaf_Controller_Abstract {
    ...
    public $webroot,$adminroot,$attachroot,$staticroot;
    ...
    public function init() {
		...
		$this->attachroot = Yaf_Application::app()->getConfig()->attachroot;
    	$this->assign("webroot", $this->webroot);
		$this->assign("staticPath", $this->staticroot . '/apps/');
		$this->assign("attachPath", $this->attachroot . '/attachs');
