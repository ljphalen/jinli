...
class Client_GiftController extends Admin_BaseController {
	...
	public function editlog_postAction() {
		...
		if(in_array($activation_code,$logs)){
			...
			Client_Service_Gift::updateGiftListToCache($giftInfo['game_id']);
	...
	public function addlog_postAction() {
		...
		//礼包列表的缓存
		Client_Service_Gift::updateGiftListToCache($gameId);
	...
	public function edit_postAction() {
	    ...
	    //礼包列表的缓存
	    Client_Service_Gift::updateGiftListToCache($info['game_id']);
		$this->output(0, '操作成功.'); 		
	}
