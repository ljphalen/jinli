...
class Page {
     ...
     */
    public function __construct($totalRows,$listRows='',$parameter='',$url='',$isFormat=true) {
    ...
    public function show() {
        ...
        if($this->url){
        	...
        	if(strpos($this->url,'http://') === false){     		           
        		...
        		$url = $this->url.(strpos($this->url,'?')=== false ? '?' : '&').$p.'='.'__PAGE__';      		
        	}        		
        }else{
           	...
           	if($this->isFormat)
            	$url            =   U('',$parameter);
           		...
           		if(isset($_REQUEST['backurl']))
           			$url            =   $_REQUEST['backurl'].'?'.$p.'=__PAGE__';
           		else 
           			$url            =   U('',$parameter);
           	}
