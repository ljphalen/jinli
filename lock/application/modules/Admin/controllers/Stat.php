...
class StatController extends Admin_BaseController {
	...
	public function pvAction() {
		...
		//pv
		list($pvlist, $pvLineData) = Lock_Service_Stat::getPvLineData($sDate, $eDate);
		list($indexPvList, $indexLineData) = Lock_Service_Stat::getIndexPvLineData($sDate, $eDate);
	...
	public function ipAction() {
		...
		//ip
		list($list, $lineData) = Lock_Service_Stat::getIpLineData($sDate, $eDate);
