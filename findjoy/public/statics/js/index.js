$(function() {
	...
	$(function(){
		$(window).scroll(function(){
			//var headh = $(".nav-fixed").offset().top;
			var headh = $(".main-side-nav").offset().top;
			var mt = headh+"px";
			if($(window).scrollTop()>headh){
				$('.top-fixed-searchlist').show();
				$("div.jiu-side-nav").css("top","0px");
				$("div.jiu-side-nav").addClass("fixed");
			}else{
				$('.top-fixed-searchlist').hide();
				$("div.jiu-side-nav").removeClass("fixed");
				$("div.jiu-side-nav").css("top",mt);
				$("div.jiu-side-nav").css("margin-top","0px");
			}
		})
	})
