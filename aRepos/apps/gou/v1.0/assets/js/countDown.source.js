(function($){
	$.extend($.fn,{
		countDown: function(options){
			...
			var _this = $(this);
			var hours = _this.find(opt.hours),
				minutes = _this.find(opt.minutes),
				seconds = _this.find(opt.seconds);

			var dateTime = {hours: '00',minutes: '00',seconds: '00'},
				remainObj = {hours: '00',minutes: '00',seconds: '00'};
			...
			function status(obj,index){
				dateTime.hours = Math.floor(obj / (1000 * 60 * 60));
				dateTime.minutes = Math.floor(obj/ (1000 * 60)) - dateTime.hours*60;
				dateTime.seconds = Math.floor(obj / 1000) - dateTime.minutes*60 - dateTime.hours*60*60;
