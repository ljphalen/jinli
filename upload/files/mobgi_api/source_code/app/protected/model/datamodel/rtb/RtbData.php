<?php
Doo::loadModel('datamodel/base/RtbDataBase');

class RtbData extends RtbDataBase{
    ...
    public function getRtbPlanRefreshData($configidsarr){
        ...
        $sql = "select  config_id, sum(imp) as total_imp, sum(click) as total_click from rtb_data where ". $where . " group by config_id ";
