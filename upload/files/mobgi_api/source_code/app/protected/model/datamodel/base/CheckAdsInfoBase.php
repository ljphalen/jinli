...
class  CheckAdsInfoBase extends AppModel{
    ...
    public $_table = 'check_ads_info';
    public $_primarykey = 'id';
    public $_fields = array('id','ad_product_id','ad_name','ad_desc','ad_click_type_object','ad_target','rate','state','pos','type','show_time','show_detail','r_id','r_type','created','updated');
