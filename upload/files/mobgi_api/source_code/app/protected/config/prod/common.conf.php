...
$config['TEMPLATE_COMPILE_ALWAYS'] = TRUE;//每次都编译

//register functions to be used with your template files
$config['TEMPLATE_GLOBAL_TAGS'] = array('url', 'url2', 'time', 'isset', 'empty','adtype');
...
//定义默认模版路径
$config['TEMPLATE_PATH']='ledou'; 
//定义域名
$config["BASEURL"]=$config['APP_URL'];
$config["MISC_BASEURL"]=$config["BASEURL"]."misc/".$config["TEMPLATE_PATH"];
/**
