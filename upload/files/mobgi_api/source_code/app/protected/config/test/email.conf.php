...
$EMAIL["mailconfig"]["host"]="smtp.126.com";
$EMAIL["mailconfig"]["username"]="frankn72@126.com";
$EMAIL["mailconfig"]["password"]="123456";
$EMAIL["mailconfig"]["port"]="25";
$EMAIL["mailconfig"]["from"]="frankn72@126.com";
$EMAIL["mailconfig"]["fromname"]="frankn72";
...
$EMAIL["mailtemplate"]["appstatechange"]['tomailers'] = array('mobgi@idreamsky.com', 'han.song@idreamsky.com',"kiki.nie@idreamsky.com","phil.chen@idreamsky.com","victor.hu@idreamsky.com","soso@idreamksy.com","stephen.feng@idreamksy.com");

$EMAIL["mailtemplate"]["appdelete"]["title"]="【应用删除提醒】 %s 应用被 %s 删除";
$EMAIL["mailtemplate"]["appdelete"]["body"]=" ";
$EMAIL["mailtemplate"]["appdelete"]['tomailers'] = array('mobgi@idreamsky.com', 'han.song@idreamsky.com',"kiki.nie@idreamsky.com","phil.chen@idreamsky.com","victor.hu@idreamsky.com","soso@idreamksy.com","stephen.feng@idreamksy.com");

$EMAIL["mailtemplate"]["appposstatechange"]["title"]="【广告位状态变更提醒】 %s 应用 %s 广告位被 %s %s";
$EMAIL["mailtemplate"]["appposstatechange"]["body"]=" ";
$EMAIL["mailtemplate"]["appposstatechange"]['tomailers'] = array('mobgi@idreamsky.com', 'han.song@idreamsky.com',"kiki.nie@idreamsky.com","phil.chen@idreamsky.com","victor.hu@idreamsky.com","soso@idreamksy.com","stephen.feng@idreamksy.com");

$EMAIL["mailtemplate"]["appposdelete"]["title"]="【广告位删除提醒】 %s 应用 %s 广告位被 %s 删除";
$EMAIL["mailtemplate"]["appposdelete"]["body"]=" ";
$EMAIL["mailtemplate"]["appposdelete"]['tomailers'] = array('mobgi@idreamsky.com', 'han.song@idreamsky.com',"kiki.nie@idreamsky.com","phil.chen@idreamsky.com","victor.hu@idreamsky.com","soso@idreamksy.com","stephen.feng@idreamksy.com");
?>
