...
//$EMAIL["mailconfig"]["host"]="smtp.qiye.163.com";
...
$EMAIL["mailtemplate"]["appstatechange"]['tomailers'] = array("stephen.feng@idreamsky.com");

$EMAIL["mailtemplate"]["appdelete"]["title"]="【应用删除提醒】 %s 应用被 %s 删除";
$EMAIL["mailtemplate"]["appdelete"]["body"]=" ";
$EMAIL["mailtemplate"]["appdelete"]['tomailers'] = array("stephen.feng@idreamsky.com");

$EMAIL["mailtemplate"]["appposstatechange"]["title"]="【广告位状态变更提醒】 %s 应用 %s 广告位被 %s %s";
$EMAIL["mailtemplate"]["appposstatechange"]["body"]=" ";
$EMAIL["mailtemplate"]["appposstatechange"]['tomailers'] = array("stephen.feng@idreamsky.com");

$EMAIL["mailtemplate"]["appposdelete"]["title"]="【广告位删除提醒】 %s 应用 %s 广告位被 %s 删除";
$EMAIL["mailtemplate"]["appposdelete"]["body"]=" ";
$EMAIL["mailtemplate"]["appposdelete"]['tomailers'] = array("stephen.feng@idreamsky.com");
