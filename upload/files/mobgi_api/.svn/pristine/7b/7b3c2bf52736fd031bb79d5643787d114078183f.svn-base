 ...
 *
 */
$route['*']['/'] = array('LoginController', 'index');
$route['*']['/genmysql'] = array('MainController', 'index');
$route['*']['/error'] = array('ErrorController', 'index');
$route['*']['/test'] = array('TestController', 'index');
$route['*']['/apps'] = array('AppsController', 'index');
$route['*']['/addApps'] = array('AppsController', 'add');
$route['*']['/editApps'] = array('AppsController', 'edit');
$route['*']['/deletApps'] = array('AppsController', 'delete');
$route['*']['/login'] = array('LoginController', 'index');
$route['*']['/adconfig/lists'] = array('AdConfigController', 'lists');
$route['*']['/adconfig/edit'] = array('AdConfigController', 'edit');
$route['*']['/adconfig/upd'] = array('AdConfigController', 'upd');
$route['*']['/adconfig/showAdConfigListPop'] = array('AdConfigController', 'showAdConfigListPop');
$route['*']['/adconfig/listconfig'] = array('AdConfigController', 'listconfig');
$route['*']['/adconfig/pushconfig'] = array('AdConfigController', 'pushconfig');
$route['*']['/adconfig/adconfig'] = array('AdConfigController', 'adconfig');
$route['*']['/adconfig/updForpush'] = array('AdConfigController', 'updForpush');
$route['*']['/adconfig/getconfigDetail'] = array('AdConfigController', 'getConfigDetail');
$route['*']['/adconfig/del'] = array('AdConfigController', 'del');
$route['*']['/adconfig/getChannelinfo'] = array('AdConfigController', 'getChannelinfo');
$route['*']['/adconfig/exchange'] = array('AdConfigController', 'exchange');
$route['*']['/adconfig/showExchangePid'] = array('AdConfigController', 'showExchangePid');
$route['*']['/pop/showad'] = array('AdController', 'edit');
$route['*']['/pop/add'] = array('AdController', 'add');
$route['*']['/adconfig/import_config'] = array('AdConfigController', 'import_config');
$route['*']['/adpostion/getpos'] = array('AdPositionController', 'getpos');
$route['*']['/adpostion/setstate'] = array('AdPositionController', 'setstate');
//渠道分类及分类下渠道信息配置
$route['*']['/sys_groups/getCategoryListCombo'] = array('CategoryController', 'getCategoryByType');
$route['*']['/channels_in_groups/GetLinkChannels'] = array('CategoryController', 'getChannelData');
  
//---------- Delete if not needed ------------
$admin = array('stephenfeng'=>'009208402&*()');

//view the logs and profiles XML, filename = db.profile, log, trace.log, profile
$route['*']['/debug/:filename'] = array('MainController', 'debug', 'authName'=>'Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');

//show all urls in app
$route['*']['/allurl'] = array('MainController', 'allurl', 'authName'=>'Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');
...
$route['*']['/gen_site'] = array('MainController', 'gen_site', 'authName'=>'Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');

//generate Models automatically
$route['*']['/gen_model'] = array('MainController', 'gen_model', 'authName'=>'Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');
$route['*']['/delviewc'] = array('MainController', 'delviewc', 'authName'=>'Admin', 'auth'=>$admin, 'authFail'=>'Unauthorized!');
