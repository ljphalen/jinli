...
class Client_Ad_TurnController extends Admin_BaseController {
	...
	public function add_postAction() {
		$info = $this->getPost(array('sort', 'title','head', 'ad_type', 'ad_ptype', 'link', 'img', 'icon', 'start_time', 'end_time', 'status','hits'));
	...
	public function edit_postAction() {
		$info = $this->getPost(array('id', 'sort', 'title','head', 'ad_type', 'ad_ptype',  'link', 'img', 'icon', 'start_time', 'end_time', 'status','hits'));
		$info['ad_type'] = $this->ad_type;
		$info = $this->_cookData($info);
