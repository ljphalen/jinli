...
class FeedbackController extends Api_BaseController {
	...
	public function myFeedbackListAction(){
		...
		$ret = Feedback_Service_Feedback::getBy($params, array('version_time'=>'DESC','id'=>'DESC'));
		...
		if ($page < 1) $page = 1;
        //取得结果
		list($total,$result) = Feedback_Service_Feedback::getList($page, $this->perpage, $params, array('create_time'=>'DESC','id'=>'DESC'));
