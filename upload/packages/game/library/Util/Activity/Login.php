...
class Util_Activity_Login extends Util_Activity_Common implements Util_Activity_Coin{  
   ...
   public function __construct($config = array()){  
        ...
        $fileName = date('Y-m-d').'_login.log';
        $this->mPath = $path;
    ...
    * @return boolean
    */
   private function  checkVersion($activityVersion, $cuurentVersion){
   	     ...
   	     $cuurentVersion = substr($cuurentVersion, 0, 5);
