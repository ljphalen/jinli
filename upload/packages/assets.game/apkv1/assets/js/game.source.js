...
;(function(iCat, $) {
    iCat.app('Gapk', function() {
        ...
        //客户端页面跳转的处理
        function skipPage(data, type,viewType,id,gameId,source) {
            if (!data) return;
            ...
            switch(version){
                ...
                case 'v2':
                    ...
                    break;
                case 'v3':
                    openV3Page(type,viewType,id,gameId,infpage,source);
                    break;
            }
        }
        ...
        function openV3Page(type,viewType,id,gameId,infpage,source){
            var cfg={}; cfg.args={ };
            ...
            openPage: function(argument) {
                ...
                $('body').delegate('a[data-infpage]', 'click', function() {
                    ...
                    if (GameApk.ApiVersion == "v1") {
                        ...
                        skipPage(data,dataType,viewType,id,gameId,source);
                    }
                });
