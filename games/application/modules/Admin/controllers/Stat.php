...
class StatController extends Admin_BaseController {
	...
	public function pvAction() {
		...
		//pv
		list($pvlist, $pvLineData) = Games_Service_Stat::getPvLineData($sDate, $eDate);
		list($indexPvList, $indexLineData) = Games_Service_Stat::getIndexPvLineData($sDate, $eDate);
	...
	public function ipAction() {
		...
		//ip
		list($list, $lineData) = Games_Service_Stat::getIpLineData($sDate, $eDate);
