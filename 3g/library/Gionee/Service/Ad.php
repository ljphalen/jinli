...
class Gionee_Service_Ad {
	...
	public static function getCanUseAdCount($params) {
		$params = self::_cookData($params);
		$ret    = self::_getDao()->getCanUseAdCount($params);
		return $ret;
	}
	...
	/**
	 *
	 * @return Gionee_Dao_Ad
	 */
	private static function _getDao() {
		return Common::getDao("Gionee_Dao_Ad");
	}
}
