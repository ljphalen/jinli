$(function(){
   $(".ch_status >li").click(function(){
       ...
       var url = "/Admin/subject/updatestatusPageList";
       if(confirm("确定修改状态?")){
      ...
      $(".ch_status_select >li").click(function(){
       var status_id = $(this).attr("val");
       window.location.href="/Admin/Subject/pagelist?status="+status_id;
   })
   //del_subject
   ...
   $(".delBtn").click(function(){
       ...
       $(".del_subject").click(function(e){
           var data = "id="+subjectid+"&token="+token+"&subjectCatatory="+"pagelist";
