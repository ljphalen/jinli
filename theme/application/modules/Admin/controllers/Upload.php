...
class UploadController extends Admin_BaseController {

    private $upload_dir = '/usr/share/nginx/www/attachs/wallpaper/attachs/';
    protected $options;
    ...
    function loadAction($options = null, $initialize = true, $error_messages = null) {
        $dirs = $this->upload_dir . $this->mk_dir();
        ...
        $this->options = array(
            ...
            'upload_dir' => $this->upload_dir . $this->mk_dir() . '/',
            'upload_url' => $this->get_full_url() . '/' . $this->mk_dir() . '/',
            'user_dirs' => false,
            'mkdir_mode' => 0755,
            'param_name' => 'files',
            'delete_type' => 'DELETE',
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error, $index = null, $content_range = null) {
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            if ($file_size === $file->size) {
                ...
                $file->width = $width;
                $file->height = $height;
                Wallpaper_Service_File::setUpFiles($file);
            } else {
                $file->size = $file_size;
