...
class SubjectserverController extends Front_BaseController {
    ...
    public function indexAction() {
        ...
        if ($subject['catagory_id'] == 9) {
            ...
            //该专题下的所有主题
            $in_ids = Theme_Service_SubjectFile::getBySubjectId($sid, array("id" => "ASC"));
            ...
            /* $res_subject = array(
              ...
              "s_descrip" => $subject['descrip'],
              "s_img" => $subject['img'],
              "s_type" => $subject['catagory_id']
              )
              ); */
