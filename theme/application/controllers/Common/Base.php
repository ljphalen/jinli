...
abstract class Common_BaseController extends Yaf_Controller_Abstract {
    ...
    public function init() {
        ...
        $this->assign("downPath", $downloadroot);
        $this->assign("webroot", $webroot);
        $this->assign("webrootDown", $webrootDown);
        $this->assign("staticPath", $staticroot . '/apps');
        $this->assign("attachPath", $webroot . '/attachs/theme/');
    ...
    public function array_sort($arr, $keys, $type = 'asc', $key = true) {
