...
class Wallpaper_BaseController extends Common_BaseController {

    public $actions = array();

    public function getAllUserInfoBase() {
        $AlluserInfo = Admin_Service_User::getAllUser();

        foreach ($AlluserInfo[1]as $v) {
            $resAlluserInfo [$v['uid']] = $v;
        }
        return $resAlluserInfo;
    }
    ...
    public function init() {
        ...
        //PV统计
        Common::getCache()->increment('Wallpaper_pv');
    }
