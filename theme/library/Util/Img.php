...
class Util_Img {
	 ...
	 *               b = bottom
	 */
	public function resize($max_width, $max_height, $method="fit", $cropAreaLeftRight="c", $cropAreaBottomTop="c", $jpgQuality=75, $isJpeg){
		...
		if($isJpeg && $image_save_func == 'ImagePNG') $image_save_func = 'ImageJPEG';
// 		if ($isJpeg) echo $image_save_func;
