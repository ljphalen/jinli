 ...
 *
 */
class Theme_Service_FileType extends Common_Service_Base{
    protected static $name = 'Theme_Dao_FileType';
    ...
    public static function updateVersion() {
        Theme_Service_Config::setValue('type_version', Common::getTime());
    }
    ...
    private static function _cookData($data) {
        ...
        if (isset($data['img'])) $tmp['url'] = $data['img'];
        return $tmp;
    }

    /**
     *
     * @return Theme_Dao_FileType
     */
    private static function _getDao() {
        return Common::getDao("Theme_Dao_FileType");
    }
