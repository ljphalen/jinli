...
return array (
		...
		'FILE_PATH_DIR' => ATTACH_PATH . 'dev/',          //应用文件存放路径，保留反斜杠
		'FILE_PATH_URL' => '/Data/Attachments/dev/',    //应用文件访问URL，保留反斜杠
		'GAMEDL_PATH_URL' => '/Data/Attachments/dev/',    //开发者平台游戏apk跟差分包文件访问URL，保留反斜杠
		'GAMEDL_API_PATH_URL' => 'http://s.dev.gionee.com/',//同步接口中apk跟拆分包使用的域名
		'ICONEXT' => array (
				'png',
				'jpg',
				'Jpg',
