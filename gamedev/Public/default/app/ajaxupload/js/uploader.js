...
qq.FineUploader = function(o){
    ...
    qq.extend(this._options, {
        ...
        }, //<div class="buttonActive"><div class="buttonContent"><button type="button" onclick="preview();">预览保存</button></div></div>
        template: '<div class="qq-uploader">' +
            ((!this._options.dragAndDrop || !this._options.dragAndDrop.disableDefaultDropzone) ? '<div class="qq-upload-drop-area"><span>{dragZoneText}</span></div>' : '') +
            (!this._options.button ? '<div class="qq-upload-button buttonActive"><div class="buttonContent"><button type="button" >{uploadButtonText}</button></div></div>' : '') +
