...
class Admin_Service_User {
	...
	public static function isLogin() {
		...
		if (!$sessionInfo || !$sessionInfo[1] || !$sessionInfo[3]) {
			return false;
		}
		if (!$userInfo = self::_getDao()->getByUsername($sessionInfo[1])) {
			return false;
		}
	...
	private static function _cookData($data) {
		$fields = array('username', 'groupid', 'email', 'registertime', 'password',);
