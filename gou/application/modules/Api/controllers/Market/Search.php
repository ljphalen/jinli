 ...
 *
 */
class Market_SearchController extends Api_BaseController {
	...
	public function keywordsAction() {
		...
		//hash
		$market_taobao_search =  json_decode(Gou_Service_Config::getValue('market_taobao_search'), true);
		$action = Common::tjurl(Stat_Service_Log::URL_SEARCH, Stat_Service_Log::V_MARKET, $market_taobao_search['module_id'],
		        $market_taobao_search['channel_id'], 0, $market_taobao_search['url'], '市场版淘宝搜索', $market_taobao_search['channel_code']);
	...
	public function submitAction() {
	   ...
	   //hash
		$market_taobao_search =  json_decode(Gou_Service_Config::getValue('market_taobao_search'), true);
		$s_url = Common::tjurl(Stat_Service_Log::URL_SEARCH, Stat_Service_Log::V_MARKET, $market_taobao_search['module_id'],
		        $market_taobao_search['channel_id'], 0, $market_taobao_search['url'], '市场版淘宝搜索', $market_taobao_search['channel_code']);
