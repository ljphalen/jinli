 ...
 *
 */
class Channel_ShopController extends Api_BaseController {
	...
	public $cacheKey = 'Channel_Shop_index';

    public function tagAction(){
        list(,$shops) = Client_Service_Shops::getsBy(array('channel_id'=>3,'tag_id'=>array('<>','')));
        $tags = array();
        foreach ($shops as $v) {
	...
	public function indexAction() {
        ...
        $search = array('status'=>1, 'channel_id'=>3);
