 ...
 *
 */
class App_NewController extends Api_BaseController {
	...
	public function indexAction() {
		...
		foreach ($goods as $key=>$value) {
			...
			$data[$key]['img'] = strpos($value['img'], 'http://') === false ? 
				Common::getAttachPath()  .$value['img'] : 
				$value['img'].'_460x460.'.end(explode(".",  $value['img']));
