...
class OrderfreelogController extends Admin_BaseController {
	...
	public function indexAction() {
		...
		list($total, $logs) = Gou_Service_OrderFreeLog::getList($page, $perpage, $search);
	...
	public function editAction() {
		$id = $this->getInput('id');
		$Info = Gou_Service_OrderFreeLog::getOrderFreeLog(intval($id));
	...
	public function edit_postAction() {
		...
		$ret = Gou_Service_OrderFreeLog::updateOrderFreeLog($info, intval($info['id']));
