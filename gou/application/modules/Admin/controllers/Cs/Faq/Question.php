 ...
 *
 */
class Cs_Faq_QuestionController extends Admin_BaseController {
	...
	public function indexAction(){
        ...
        $params = $this->getInput(array('cat_id', 'answer', 'question', 'status'));
	...
	public function add_postAction(){
		$info = $this->getPost(array('sort', 'question', 'cat_id', 'status', 'answer'));
	...
	public function edit_postAction(){
        $info = $this->getPost(array('id', 'sort', 'question', 'cat_id', 'status', 'answer'));
        $info = $this->_cookData($info);
    ...
    private function _cookData($info) {
        ...
        $info['question'] = html_entity_decode($info['question']);
        $info['answer']   = html_entity_decode($info['answer']);
        $info['answer'] = $this->updateImgUrl($info['answer']);
        return $info;
    }
}