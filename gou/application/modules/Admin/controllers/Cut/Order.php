 ...
 *
 */
class Cut_OrderController extends Admin_BaseController {
	
	public $actions = array(
		'indexUrl' =>'/admin/Cut_order/index',
		'editUrl'=>'/admin/Cut_order/edit',
		'editPostUrl'=>'/admin/Cut_order/edit_post',
		'addUrl'=>'/admin/Cut_order/add',
		'exportUrl'=>'/admin/Cut_order/export',
		'addPostUrl'=>'/admin/Cut_order/add_post',
		'syncUrl'=>'/admin/Cut_order/sync',
		'editOrderAjax'=>'/admin/Cut_order/editorder',
	   'refundUrl'=>'/admin/Cut_order/refund',
	);
	...
	public function edit_postAction() {
		...
		if($order['status'] != 4 && ($status == 4)) {
			...
			if($express_code[0] && $express_code[1]) {
				Common::sms($order['phone'], 'Hi 亲爱的小伙伴，您在砍价专区活动购买的商品已经发货，物流公司:'.$express_code[0].'，运单号：'.$express_code[1].'，打开购物大厅，进入我的订单可查看物流 ~感谢亲对购物大厅的支持！');
			}
		}
