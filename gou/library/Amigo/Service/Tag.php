...
class Amigo_Service_Tag{
	...
	public static function getAllTag() {
		return array(self::_getDao()->count(), self::_getDao()->getAll(array('sort'=>'DESC','id'=>'DESC')));
	}
    ...
    public static function getsBy($params=array(),$sort=array()) {
		if (!is_array($params)) return false;
        if(empty($sort))$sort=array('sort'=>'DESC','id'=>'DESC');
	...
	/**
	 * 
	 * @return Amigo_Dao_Tag
	 */
	private static function _getDao() {
		return Common::getDao("Amigo_Dao_Tag");
	}
}
