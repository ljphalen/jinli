 ...
 *
 */
class Mall_Dao_Ad extends Common_Dao_Base{
	protected $_name = 'gou_mall_ad';
	 ...
	 */
	public function getAllMalladCount($params) {
		$time = Common::getTime();
	 ...
	 * @param unknown_type $params
	 */
	public function getCanUseMallads($start, $limit, $params) {
		$time = Common::getTime();
	 ...
	 * @param unknown_type $params
	 */
	public function getCanUseMalladCount($params) {
		$time = Common::getTime();
		$where = Db_Adapter_Pdo::sqlWhere($params);
