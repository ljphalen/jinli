 ...
 *
 */
class Client_Service_Channelgoodscate extends Common_Service_Base {
	...
	public static function updateCategory($data, $id){
		...
		try {
			...
			/* if ($data['status'] == 0){
				self::_getDaoSub()->updateBy(array('status'=>0), array('goods_type'=>intval($id)));
			} */
	...
	private static function _getDao() {
		return Common::getDao("Client_Dao_Channelgoodscate");
	}
