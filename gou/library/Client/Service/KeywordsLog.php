 ...
 *
 */
class Client_Service_KeywordsLog{
	...
	public static function search($page = 1, $limit = 20, $params = array()) {
		...
		$ret = self::_getDao()->sBy($start, $limit, $sqlWhere);
...
// 		return array($total, $ret);
	...
	private static function _cookData($data) {
		...
		if(isset($data['keyword'])) $tmp['hash'] = Common::hash_crc32($data['keyword']);
		return $tmp;
	}
	
	/**
	 * 
	 * @return Client_Dao_KeywordsLog
	 */
	private static function _getDao() {
		return Common::getDao("Client_Dao_KeywordsLog");
	}
}
