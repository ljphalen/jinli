...
class Gou_Service_Subject{
	...
	public static function updateSubjectTJ($id) {
		if (!$id) return false;
		Gou_Service_ClickStat::increment(4, $id);
	...
	private static function _cookData($data) {
		...
		if(isset($data['st_type'])) $tmp['st_type'] = intval($data['st_type']);
	...
	/**
	 * 
	 * @return Gou_Dao_Subject
	 */
	private static function _getDao() {
		return Common::getDao("Gou_Dao_Subject");
	}
}
