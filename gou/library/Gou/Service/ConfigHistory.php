...
/**
 *
 * Gou_Service_ConfigHistory
 * @author Milo
 *
*/
class Gou_Service_ConfigHistory{
	...
	private static function _cookData($data) {
		...
		if(isset($data['src'])) $tmp['src'] = $data['src'];
	 ...
	 * 
	 *
	 * @return Gou_Dao_ConfigHistory
	 */
	private static function _getDao() {
		return Common::getDao("Gou_Dao_ConfigHistory");
	}
