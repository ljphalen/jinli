...
class Gou_Service_Resource{
	...
	public static function updateTJ($id) {
		if (!$id) return false;
		Gou_Service_ClickStat::increment(12, $id);
	...
	private static function _cookData($data) {
		...
		if(isset($data['version_name'])) $tmp['version_name'] = $data['version_name'];
		...
		if(isset($data['md5_sign'])) $tmp['md5_sign'] = $data['md5_sign'];
		return $tmp;
	}
	...
	private static function _getDao() {
		return Common::getDao("Gou_Dao_Resource");
	}
}
