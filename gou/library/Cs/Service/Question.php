...
class Cs_Service_Question {
    ...
    public static function countByGroup($params = array(), $group = "")
    {
        return static::_getDao()->countByGroup($params, $group);
    }
	...
	protected static function _cookData($data) {
        ...
        if(isset($data['answer']))   $tmp['answer']   = html_entity_decode($data['answer']);
		return $tmp;
	}
	
	/**
	 * 
	 * @return Cs_Dao_Question
	 */
	protected static function _getDao() {
		return Common::getDao("Cs_Dao_Question");
	}
}
