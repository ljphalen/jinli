...
class Activity_Service_Share{
	...
	public static function getList($page = 1, $limit = 10, $params = array()) {
		...
		if ($page < 1) $page = 1;
		$start = ($page - 1) * $limit;
		$ret = self::_getDao()->getList($start, $limit, $params, array('hits'=>'DESC'));
	...
	public static function search($page = 1, $limit = 10, $params = array()) {
		...
		$ret = self::_getDao()->searchBy($start, $limit, $sqlWhere, array('hits'=>'DESC'));
	...
	/**
	 *
	 * @return Activity_Dao_Share
	 */
	private static function _getDao() {
		return Common::getDao("Activity_Dao_Share");
	}
}
