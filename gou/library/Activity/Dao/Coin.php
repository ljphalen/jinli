 ...
 *
 */
class Activity_Dao_Coin extends Common_Dao_Base{
	protected $_name = 'gou_activity_coin';
	 ...
	 */
	public function getCanUses($start, $limit, $params) {
		$time = Common::getTime();
	 ...
	 * @param unknown_type $params
	 */
	public function getCanUseCount($params) {
		$time = Common::getTime();
		$where = Db_Adapter_Pdo::sqlWhere($params);
