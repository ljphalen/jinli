...
class Api_Top_Service extends Api_Top_Base {
	 ...
	 * 天猫折扣精选商品库
	 *
	 * @param array $params 	tmall.items.discount.search 参数
	 * @return array
	 */
	public function tmallItemsDiscountSearch(array $params) {
		if (! array_key_exists ( 'q', $params ))
			return array ();
		$args = func_get_args ();
		return $this->cacheFactory ( __FUNCTION__, $args );
	 ...
	 * @param string $numIid  	淘宝客商品数字id串
	 */
	public function getTaobaokeItemDetail(array $params) {
		$args = func_get_args ();
		return $this->cacheFactory ( __FUNCTION__, $args );
	}
	 ...
	 * @return array
	 */
	public function TaobaokeMobileShopsConvert(array $params) {
		if (! array_key_exists ( 'sids', $params ) && ! array_key_exists ('seller_nicks', $params ))
			return array ();
		$args = func_get_args ();
		return $this->cacheFactory ( __FUNCTION__, $args );
	 ...
	 * @return array
	 */
	public function tbkMobileItemsConvert(array $params) {
	 ...
	 * @return array
	 */
	public function taobaokeMobileItemsRelate(array $params) {
		if (! array_key_exists ( 'relate_type', $params ))
			return array ();
		$args = func_get_args ();
		return $this->cacheFactory ( __FUNCTION__, $args );
	 ...
	 * 返利授权查询
	 *
	 * @param array $params 	taobao.taobaoke.rebate.auth.get 参数
	 * @return array
	 */
	public function getTaobaoTaobaokeRebateAuth(array $params) {
	 ...
	 * 返利订单查询
	 *
	 * @param array $params 	taobao.taobaoke.rebate.report.get 参数
	 * @return array
	 */
	public function getTaokeRebateReport(array $params) {
		if (! $params) return array ();
		$args = func_get_args ();
		return $this->cacheFactory ( __FUNCTION__, $args );
	}
	 ...
	 * 获取授权访问令牌
	 *
	 * @param array $params 	alipay.system.oauth.token 参数
	 * @return array
	 */
	/*public function alipaySystemOauthToken() {
		$url = Common::getConfig('apiConfig', 'taobao_top_api_https_url');
		$postFields = array(
				...
				'app_key' => $this->internet_appkey
		);
		$ret =  parent::curl ( $url, $postFields );
		print_r($ret);die;
	 ...
	 * @return array
	 */
	public function getTbkShopInfo($params) {
	    if (! array_key_exists ( 'sids', $params ) && ! array_key_exists ( 'seller_nicks', $params ))
	        return array ();
	    $args = func_get_args ();
	    return $this->cacheFactory ( __FUNCTION__, $args );
	 ...
	 * @return array
	 */
	public function alipaySystemOauthToken(array $params) {
		if (! $params) return array ();
		$args = func_get_args ();
		return $this->cacheFactory ( __FUNCTION__, $args );
	}
