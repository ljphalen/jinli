...
$ini_db = array(
	// 'db1'=>array('host'=>'192.168.1.200', 'port'=>3306, 'uid'=>'test', 'pwd'=>'mykj@123.Abc', 'db'=>'agent', 'type'=>'mysqli')
   'db1'=>array('host'=>'106.3.41.114', 'port'=>3306, 'uid'=>'webpay', 'pwd'=>'sT@dmin<>2012', 'db'=>'agent', 'type'=>'mysqli')
   //'db1'=>array('host'=>'localhost', 'port'=>3308, 'uid'=>'webpay', 'pwd'=>'root', 'db'=>'agent', 'type'=>'mysqli')
