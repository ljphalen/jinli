...
class Client_HdController extends Admin_BaseController {
	...
	public function add_postAction() {
		$info = $this->getPost(array('sort', 'game_id', 'title', 'img', 'status', 'start_time', 'end_time', 'content', 'update_time', 'placard', 'award'));
	...
	public function edit_postAction() {
		$info = $this->getPost(array('id', 'sort', 'game_id', 'title', 'img', 'status', 'start_time', 'end_time', 'content', 'update_time', 'placard', 'award'));
		$info = $this->_cookData($info);
	...
	private function _cookData($info) {
		...
		if(!$info['award']) $this->output(-1, '活动奖励不能为空.');
