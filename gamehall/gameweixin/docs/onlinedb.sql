...
insert into `admin_user` (`id`, `username`, `password`, `hash`) values('4','admin','15f0639981faed69bf1871e174336ebb','aEknH9');

insert into `admin_user` (`id`, `username`, `password`, `hash`) values('5','yanlv','55c24119160aed9329d69ab47eeaf3d2','GChW5Z');
insert into `admin_user` (`id`, `username`, `password`, `hash`) values('6','administrators','c89af10d80af5fd848afe609f2a6e0b2','ItiMQ9');
insert into `admin_user` (`id`, `username`, `password`, `hash`) values('7','yinjiayan','36b94dcaf3f2622b3d7d203f9a084e62','FH22M5');
