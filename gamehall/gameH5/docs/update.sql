...
-- ----------------------------
-- Table structure for `game_h5_index_ad`
-- ----------------------------
...
-- ----------------------------
-- Records of game_h5_index_ad
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend`
-- ----------------------------
...
CREATE TABLE `game_h5_recommend` (
  ...
  KEY `title` (`title`)
) ENGINE=InnoDB AUTO_INCREMENT=123 DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐集合';

-- ----------------------------
-- Records of game_h5_recommend
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_banner`
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐banner图';

-- ----------------------------
-- Records of game_h5_recommend_banner
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_banner_tmp`
-- ----------------------------
...
CREATE TABLE `game_h5_recommend_banner_tmp` (
  ...
  KEY `idx_sort` (`sort`),
  KEY `idx_link` (`link_type`,`link`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐banner图';

-- ----------------------------
-- Records of game_h5_recommend_banner_tmp
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_copy`
-- ----------------------------
DROP TABLE IF EXISTS `game_h5_recommend_copy`;
CREATE TABLE `game_h5_recommend_copy` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  `content` varchar(255) DEFAULT NULL COMMENT '描述',
  `start_time` int(10) NOT NULL DEFAULT '0' COMMENT '开始时间',
...
-- ----------------------------
-- Records of game_h5_recommend_copy
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_delete_tmp`
-- ----------------------------
...
-- ----------------------------
-- Records of game_h5_recommend_delete_tmp
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_edit_log`
-- ----------------------------
...
CREATE TABLE `game_h5_recommend_edit_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_day_id` (`day_id`)
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=utf8 COMMENT='H5首页_首页编辑记录';

-- ----------------------------
-- Records of game_h5_recommend_edit_log
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_games`
-- ----------------------------
...
-- ----------------------------
-- Records of game_h5_recommend_games
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_games_tmp`
-- ----------------------------
...
-- ----------------------------
-- Records of game_h5_recommend_games_tmp
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_hdnew`
-- ----------------------------
...
-- ----------------------------
-- Records of game_h5_recommend_hdnew
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_hdnew_tmp`
-- ----------------------------
...
-- ----------------------------
-- Records of game_h5_recommend_hdnew_tmp
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_imgs`
-- ----------------------------
...
-- ----------------------------
-- Records of game_h5_recommend_imgs
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_imgs_tmp`
-- ----------------------------
...
-- ----------------------------
-- Records of game_h5_recommend_imgs_tmp
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_list`
-- ----------------------------
...
-- ----------------------------
-- Records of game_h5_recommend_list
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_rank`
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=42 DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐图片';

-- ----------------------------
-- Records of game_h5_recommend_rank
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_rank_tmp`
-- ----------------------------
...
CREATE TABLE `game_h5_recommend_rank_tmp` (
  ...
  KEY `idx_recommend_id` (`recommend_id`),
  KEY `idx_rank_type` (`rank_type`)
) ENGINE=InnoDB AUTO_INCREMENT=41 DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐图片';

-- ----------------------------
-- Records of game_h5_recommend_rank_tmp
-- ----------------------------

-- ----------------------------
-- Table structure for `game_h5_recommend_tmp`
-- ----------------------------
...
CREATE TABLE `game_h5_recommend_tmp` (
  ...
  KEY `end_time` (`end_time`),
  KEY `title` (`title`)
) ENGINE=InnoDB AUTO_INCREMENT=121 DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐集合';
