 ...
 *
 */
class Client_Ad_RecpicController extends Admin_BaseController {
	
	public $actions = array(
		'listUrl' => '/Admin/Client_Ad_Recpic/index',
		'addUrl' => '/Admin/Client_Ad_Recpic/add',
		'addPostUrl' => '/Admin/Client_Ad_Recpic/add_post',
		'editUrl' => '/Admin/Client_Ad_Recpic/edit',
		'editPostUrl' => '/Admin/Client_Ad_Recpic/edit_post',
		'setUrl' => '/Admin/Client_Ad_Recpic/set',
		'setPostUrl' => '/Admin/Client_Ad_Recpic/set_post',
		'deleteUrl' => '/Admin/Client_Ad_Recpic/delete',
		'uploadUrl' => '/Admin/Client_Ad_Recpic/upload',
		'uploadPostUrl' => '/Admin/Client_Ad_Recpic/upload_post',
		'batchUpdateUrl'=>'/Admin/Client_Ad_Recpic/batchUpdate'
	);
	...
	public function setAction() {
		...
		$space157 = Game_Service_Config::getValue('client_picture_space157');
		$status = Game_Service_Config::getValue('client_picture_status');
		$this->assign('space', $space);
		$this->assign('space157', $space157);
		$this->assign('status', $status);
	}
	
	public function set_postAction() {
		$config = $this->getPost(array('client_picture_space', 'client_picture_status', 'client_picture_space157'));
