...
class SubjectController extends Game_BaseController {
	...
	public $actions =array(
	            ...
	            'moreGameAjax' => '/index/moreGameAjax/',
	...
	public function indexAction() {
        ...
        $this->assign('data', json_encode(array('list' => $data, 'hasNext' => $hasNext, 'curPage' => $page, 'ajaxUrl' => $this->actions['listAjax']))); 
	}
    ...
    private function getSubjectList() {
        ...
        foreach ($subjectList as $subject) {
            $item = array(
                            ...
                            'info' => html_entity_decode($subject['resume']),
                            'href' => '/subject/detail?id='.$subject['id']
            );
            $data[] = $item;
        }
	...
	private function getSubjectGameList($subject) {
	    ...
	    $data = array(
	                    ...
	                    'ajaxUrl' => $this->actions['moreGameAjax'].'?id='.$id
	    );
