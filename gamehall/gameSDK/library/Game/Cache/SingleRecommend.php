...
/**
 * 单机推荐日程
 * Game_Cache_SingleRecommend
 * @author wupeng
 */
class Game_Cache_SingleRecommend extends Cache_Base {
	public $expire = 86400;
	private $dataList;
	private $controll;
	private $api;
	...
	public function __construct() {
	    $this->api = Util_CacheKey::getApi(Util_CacheKey::SINGLEGAME, Util_CacheKey::SINGLEGAME_LIST);
	...
	public static function getInstance() {
	    if(! self::$instance) {
	        self::$instance = new Game_Cache_SingleRecommend();
	    }
