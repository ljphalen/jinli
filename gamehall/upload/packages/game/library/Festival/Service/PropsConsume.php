 ...
 *
 */
class Festival_Service_PropsConsume{
	...
	const FIELD_CONSUME_NUM ='consume_num';
	...
	private static function cookData($data) {
		...
		if(isset($data[self::FIELD_CONSUME_NUM])) $tmp[self::FIELD_CONSUME_NUM] = $data[self::FIELD_CONSUME_NUM];
	...
	/**
	 * 
	 * @return Festival_Dao_PropsConsume
	 */
	private static function getDao() {
		return Common::getDao("Festival_Dao_PropsConsume");
	}
}
