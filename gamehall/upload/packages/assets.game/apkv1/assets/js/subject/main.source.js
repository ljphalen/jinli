    ...
    skipPage:function(){
        ...
        $('body').delegate('.J_gotoDetail','click',function(){
            var container=$(this).siblings('.J_btn'),
                ...
                packageName = container.attr('data-packagename');
            subject.openPage(1,'GameDetailView',id,gameId,title,'',source,packageName);
        });
    },
    openPage:function(type,viewType,id,gameId,title,url,source,packageName){
        var cfg={}; cfg.args={ };
