 ...
 *
 */
class Client_Ad_MagneticonController extends Admin_BaseController {
	
	public $actions = array(
		'listUrl' => '/Admin/Client_Ad_Magneticon/index',
		'addUrl' => '/Admin/Client_Ad_Magneticon/add',
		'addPostUrl' => '/Admin/Client_Ad_Magneticon/add_post',
		'editUrl' => '/Admin/Client_Ad_Magneticon/edit',
		'editPostUrl' => '/Admin/Client_Ad_Magneticon/edit_post',
		'setUrl' => '/Admin/Client_Ad_Magneticon/set',
		'setPostUrl' => '/Admin/Client_Ad_Magneticon/set_post',
		'deleteUrl' => '/Admin/Client_Ad_Magneticon/delete',
		'uploadUrl' => '/Admin/Client_Ad_Magneticon/upload',
		'uploadPostUrl' => '/Admin/Client_Ad_Magneticon/upload_post',
		'batchUpdateUrl'=>'/Admin/Client_Ad_Magneticon/batchUpdate'
	);
	
	public $perpage = 20;
	public $ad_type = Client_Service_Ad::AD_TYPE_MAGNETICON;
	...
	public $versionName = 'Magneticon_Ad_Version';
	...
	public function add_postAction() {
		...
		if($info['ad_ptype'] != 4){
			$this->_getMsg($adInfo, $tip,$info['ad_ptype'],$info['link']);
		}
	...
	public function _getData($ad_ptype) {
		list(, $ads) = Client_Service_Ad::getsBy(array('ad_type'=>11));
		$tmp = array();
	...
	public function edit_postAction() {
		...
		$result = Game_Service_Util_Link::checkLinkValue($info['ad_ptype'], $info['link']);
		if($result) {
	...
	public function setAction() {
		$space = Game_Service_Config::getValue('client_picture_space');
		$status = Game_Service_Config::getValue('client_picture_status');
		$this->assign('space', $space);
		$this->assign('status', $status);
	}
	
	public function set_postAction() {
		$config = $this->getPost(array('client_picture_space', 'client_picture_status'));
