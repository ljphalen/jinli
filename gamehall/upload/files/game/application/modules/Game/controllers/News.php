...
class NewsController extends Game_BaseController{
	...
	private function getNewsData() {
	    ...
	    list($total, $news) = Client_Service_News::getUseNews($page, $this->perpage, array('ntype' => array('IN',array(1,3)), 'create_time' => array('<=', Util_TimeConvert::floor(time(), Util_TimeConvert::RADIX_HOUR)), 'status'=>1));
	    ...
	    foreach ($news as $value) {
	        ...
	        $item['href'] = Util_Statist::getZXDetailUrl($value['id']);
