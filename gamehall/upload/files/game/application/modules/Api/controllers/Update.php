...
class UpdateController extends Api_BaseController {
	...
	private $webroot = "";
	private $cache = null;
    const UPDATE_LOG_FILE_NAME = 'game_update.log';
    ...
    public function updateAction() {
    	...
    	$msg = array('apkInfo'=>$apkInfo, 'info'=>$info);
    	Util_Log::info(__CLASS__, self::UPDATE_LOG_FILE_NAME, $msg);
    ...
    private function extractGames($apkInfo){
		...
		$msg = array('apkInfoKeys'=>$apkInfoKeys);
		Util_Log::info(__CLASS__, self::UPDATE_LOG_FILE_NAME, $msg);
		...
		$msg = array('packageInfo'=>$packageInfo);
		Util_Log::info(__CLASS__, self::UPDATE_LOG_FILE_NAME, $msg);
		return $packageInfo;
	}
