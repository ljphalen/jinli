...
class Client_Service_SubjectGames {
	...
	public static function getPageDistinctGameList($page = 1, $limit = 10, $searchParams = array(), $sortParams = array('sort'=>'desc', 'game_id'=>"desc")) {
		if ($page < 1) $page = 1; 
		$start = ($page - 1) * $limit;
	...
	public static function getSubjectGamesBy($searchParams = array(), $sortParams = array('sort'=>'desc', 'game_id'=>"desc")) {
	...
	public static function getItemGames($id, $item_id) {
	    return self::getDao()->getsBy(array('subject_id' => $id, 'item_id' => $item_id), array('sort'=>'desc', 'game_id'=>"desc"));
	}
	...
	public static function getSubjectAllGames($id) {
	    return self::getDao()->getsBy(array('subject_id' => $id), array('sort'=>'desc', 'game_id'=>"desc"));
	}

	public static function getSubjectAllItemsGames($id) {
	    return self::getDao()->getsBy(array('subject_id' => $id), array('item_id' => 'asc', 'sort'=>'desc', 'game_id'=>"desc"));
	}
