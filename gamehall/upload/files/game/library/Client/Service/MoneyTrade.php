...
class Client_Service_MoneyTrade{
    ...
    // event 字段
    const TRADE_EVENT_CONSUME = 1;
    const TRADE_EVENT_PAYMENT = 2;
	...
	public static function getTradeGameList($params = array(), $limit = 10) {
	    return self::_getDao()->getTradeGameList($params, $limit);
	}
	 ...
	 * @return multitype:unknown multitype:
	 */
	public static function getBy($params = array() , $orderBy=array('trade_time'=>'DESC','id'=>'DESC')){
	 ...
	 * @return multitype:unknown multitype:
	 */
	public static function getsBy($params = array(), $orderBy=array('trade_time'=>'DESC','id'=>'DESC') ){
