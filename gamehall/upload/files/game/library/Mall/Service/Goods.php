...
class Mall_Service_Goods extends Common_Service_Base{
	...
	public function getGoodDiscountCss($consumePoint) {
	    $consumePoint = Mall_Service_Goods::convertPointVal($consumePoint);
	    return '特价：<span class="font-orange">'.$consumePoint.'</span>';
	}
