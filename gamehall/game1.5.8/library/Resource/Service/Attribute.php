...
class Resource_Service_Attribute extends Common_Service_Base{
	...
	public static function getGuessGameData($sp, $filter = array()) {
		...
		if(strnatcmp($version, '1.5.1') < 0 && $currentTime >= $startTime && $currentTime <= $endTime){
		    $gues =1;
		    list(, $games) = self::guessTemporaryList(1);
		}
	...
	public  static function guessTemporaryList($page) {
	    if (ENV == 'product') {
	        $ids = array('117','2167','3624','5201','4044','1530','5171','5035','4176','5220','5200','4116',
	                '5161','2471','4610','5222','2417','3692','5176','1522','5097','5183','5221','4280','2635',
	                '4340','3349','2186','5128','2783');
	    } else {
	        $ids = array('286','23','285','284','283','282','281','279','278','269','268','277',
	                '280','45','14','3','181','79','234','1','274','276','238','237','128',
	                '242','106','200','116','249');
	    }
	    list($total, $games) = Resource_Service_Games::search($page, 10, array('id'=>array('IN', $ids),'status'=>1));
