...
class Client_Service_GiftActivity extends Common_Service_Base{
	...
	private static function updateActivationCodeLog($userInfo, $giftActivityInfo, $remainActivationCode){
	    ...
	    if($ret){
	        ...
	        self::updateMygiftLogsCache($updateField, $giftActivityInfo, $remainActivationCode, $userInfo['version']);
	    }
	}
	
	private static function updateMygiftLogsCache($updateField, $giftActivityInfo, $remainActivationCode, $version){
	    $myGiftLogInfo = array('log_id' => $remainActivationCode['id'],
	                           'log_type' => Client_Service_MyGiftLog::SEND_GIFT_LOG,
	   ...
	   Client_Service_MyGiftLog::updateMygiftLogsCache($updateField, $myGiftLogInfo, $version);
	}
