...
function updateApkFileSize() {	
	$page = 1;
	do {
		list($apkTotal, $apkList) = Resource_Service_Games::getVersionGames($page , 100);
...
function updatePackageFilesize() {
	$page = 1;
	do {
		list($diffPackageTotal, $diffPackageList) = Resource_Service_Games::getDiffPackageList($page  ,100);
