ALTER TABLE `game_exchange_point_log` ADD `qq` varchar(255) NOT NULL DEFAULT '0' AFTER `receiverphone`;
-- 手动发送a券赠送原因log
-- Created By lichanghua@2015-10-27
DROP TABLE IF EXISTS `game_client_grabgift_warn_email`;
CREATE TABLE `game_client_grabgift_warn_email` (
   `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
   `status` tinyint(3) unsigned NOT NULL DEFAULT '0',
   `gift_id` int(10) NOT NULL COMMENT '礼包id',
   `is_zero` tinyint(3) unsigned NOT NULL DEFAULT '0',
   `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '添加时间',
   PRIMARY KEY (`id`),
   KEY `idx_uname_good_id` (`status`,`gift_id`),
 ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
alter table `game_client_task_hd` add column `ticket_type` tinyint(3) NOT NULL DEFAULT 0 COMMENT '代金券类型【1：A券； 2：游戏券】' after `htype`;
alter table `game_client_task_hd` add column `ticket_object` tinyint(3) NOT NULL DEFAULT 0 COMMENT '游戏券使用范围：【1：全平台； 2：游戏券】' after `ticket_type`;
alter table `game_client_ticket_trade` add column `ticket_type` tinyint(3) NOT NULL DEFAULT 0 COMMENT '代金券类型【1：A券；2：游戏券】' after `uuid`;
alter table `game_client_ticket_trade` add column `game_id` int(10) NOT NULL DEFAULT 0 COMMENT '【游戏平台：117  特定游戏：非0的数字id】' after `ticket_type`;
alter table `game_client_ticket_trade` add column `useable` tinyint(3) NOT NULL DEFAULT 1 COMMENT '【是否可用：0 不可用 1可用  】' after `use_denomination`;
alter table `game_client_ticket_trade` add column `balance` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '代金券的余额' after `use_denomination`;

ALTER TABLE  `game_user_info` 
	ADD  `vip` TINYINT( 1 ) DEFAULT '0' COMMENT  'vip等级',
	ADD  `vip_mon_expr` DECIMAL( 18, 2 ) DEFAULT '0.00' COMMENT  '消费经验',
	ADD  `vip_act_expr` DECIMAL( 18, 2 ) DEFAULT '0.00' COMMENT  '活动经验',
	ADD  `vip_rank` INT( 10 ) DEFAULT '0' COMMENT  'vip排行';

ALTER TABLE  `game_user_info` ADD  `qq` VARCHAR( 30 ) NULL DEFAULT  '' COMMENT  'qq' AFTER  `receiverphone`;

CREATE TABLE IF NOT EXISTS `game_user_vip_flg` (
  `uuid` varchar(50) NOT NULL COMMENT '用户的id',
  `gift` tinyint(1) DEFAULT '0' COMMENT '打开礼包时等级',
  `ticket` tinyint(1) DEFAULT '0' COMMENT '领取A券时等级',
  PRIMARY KEY (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户vip标识';

CREATE TABLE IF NOT EXISTS `game_user_vip_expr` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `uuid` varchar(50) NOT NULL COMMENT '用户的id',
  `type` tinyint(3) NOT NULL COMMENT '渠道类型',
  `add_expr` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '增加成长值',
  `expr` decimal(18,2) NOT NULL DEFAULT '0.00' COMMENT '最终成长值',
  `logs` varchar(100) DEFAULT '' COMMENT '渠道日志',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '获取时间',
  PRIMARY KEY (`id`),
  KEY `idx_uuid` (`uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='vip成长值' AUTO_INCREMENT=1 ;
	
CREATE TABLE IF NOT EXISTS `game_user_game_log` (
  `uuid` varchar(50) NOT NULL COMMENT '用户的id',
  `game_id` int(10) NOT NULL COMMENT '游戏id',
  `consume_time` int(10) DEFAULT '0' COMMENT '最后消费时间',
  `login_time` int(10) DEFAULT '0' COMMENT '获取时间',
  PRIMARY KEY (`uuid`,`game_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户玩游戏记录';

ALTER TABLE  `game_resource_games` ADD INDEX `idx_api_key` (  `api_key` );
ALTER TABLE  `game_client_money_trade` ADD INDEX  `idx_event` (  `event` );

CREATE TABLE IF NOT EXISTS `game_user_vip_icon` (
  `vip` tinyint(3) NOT NULL DEFAULT '0' COMMENT 'vip等级',
  `img` varchar(255) NOT NULL DEFAULT '' COMMENT 'icon',
  PRIMARY KEY (`vip`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='vip图标';


ALTER TABLE `game_client_gift` ADD `vip_level` varchar(255) NOT NULL DEFAULT '0' AFTER `game_id`;
ALTER TABLE `game_client_gift` ADD `dev_email` varchar(255) NOT NULL DEFAULT '0' AFTER `vip_level`;
update game_client_gift set vip_level =1;
-- TableName game_client_gift_exchange_log 兑换礼包日志表
-- Created By lichanghua@2015-10-12
-- Fields id 		         自增ID
-- Fields good_id 	         商品ID
-- Fields uname 	         账号名称
-- Fields uuid 	             账号uuid
...
-- Created By lichnaghua@2015-10-12
DROP TABLE IF EXISTS `game_client_gift_exchange_log`;
CREATE TABLE `game_client_gift_exchange_log` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uname_good_id` (`uname`,`good_id`),
  KEY `idx_status` (`status`),
  KEY `idx_good_id` (`good_id`)
) ENGINE=INNODB DEFAULT CHARSET=utf8;

ALTER TABLE `game_mall_goods` ADD `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序' AFTER `id`;
ALTER TABLE `game_mall_goods` ADD `category_id` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '商品分类' AFTER `sort`;
ALTER TABLE `game_mall_goods` ADD `gift_num_type` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '礼包类型' AFTER `type`;
ALTER TABLE `game_mall_goods` ADD `exchange_rule` text NOT NULL COMMENT '商品兑换规则' AFTER `title`;
ALTER TABLE `game_mall_goods` ADD `game_object` varchar(255) NOT NULL DEFAULT '0' COMMENT 'a券应用范围' AFTER `discountArr`;
ALTER TABLE `game_mall_goods` ADD `game_ids` text NOT NULL COMMENT '指定游戏id' AFTER `game_object`;
-- Created By lichanghua@2015-10-3
-- TableName game_mall_goods_category 积分商城商品分类表
-- Fields id 		     自增ID
-- Fields sort           排序
-- Fields goods_type     商品分类类型
-- Fields title　        分类名称
-- Fields status         分类状态
-- Fields create_time    创建时间
DROP TABLE IF EXISTS game_mall_goods_category;
CREATE TABLE `game_mall_goods_category` (
	`id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
	`sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
	`goods_type`tinyint(1) NOT NULL DEFAULT '0' COMMENT '商品分类类型',
...
INSERT INTO `game_mall_goods_category` (`id`, `sort`, `goods_type`, `title`, `status`, `create_time`) VALUES (NULL, '0', '0', '限时秒杀', '1', '1445070820');
INSERT INTO `game_mall_goods_category` (`id`, `sort`, `goods_type`, `title`, `status`, `create_time`) VALUES (NULL, '0', '2', '游戏券赠送', '1', '1445070821');
INSERT INTO `game_mall_goods_category` (`id`, `sort`, `goods_type`, `title`, `status`, `create_time`) VALUES (NULL, '0', '1', '实物奖品', '1', '1445070822');
INSERT INTO `game_mall_goods_category` (`id`, `sort`, `goods_type`, `title`, `status`, `create_time`) VALUES (NULL, '0', '3', '游戏礼包', '1', '1445070823');
update game_mall_goods set category_id =2 where  type =2;
update game_mall_goods set category_id =3 where  type =1;

alter table `game_client_ticket_trade` add column `ticket_type` tinyint(3) NOT NULL DEFAULT 0 COMMENT '代金券类型【1：A券； 2：游戏券】' after `uuid`;
alter table `game_client_ticket_trade` add column `game_id` int(10) NOT NULL DEFAULT 0 COMMENT '代金券类型为游戏券时游戏id取值【游戏平台：117  特定游戏：非0的数字id】' after `ticket_type`;

alter table `game_resource_games` 
   add column `default_downloads` int(10) DEFAULT '0' NOT NULL COMMENT '默认下载次数',
   add column `download_status`   int(10) DEFAULT '0' NOT NULL COMMENT '默认下载次数的开关' ;
---------------------------------1.6.1开始--------------------------------------------

--------------------------------1.6.0结束----------------------------------------
alter table `game_resource_games` change `hot` `hot` int(10) default '0' NOT NULL;
ALTER TABLE `game_web_rec_banner` ADD `img_high` VARCHAR( 100 ) NOT NULL COMMENT '高清图' AFTER `img`;

CREATE TABLE IF NOT EXISTS `game_single_recommend` (
  `day_id` int(10) unsigned NOT NULL COMMENT 'ID',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`day_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='单机推荐日程';

CREATE TABLE IF NOT EXISTS `game_single_list` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  `content` varchar(255) DEFAULT NULL COMMENT '描述',
  `day_id` int(10) NOT NULL DEFAULT '0' COMMENT '生效日期',
  `rec_type` tinyint(1) DEFAULT '0' COMMENT '0:合集,1:图片,2:单个,3:礼包',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:关闭,1:开启',
  `sort` tinyint(1) NOT NULL DEFAULT '0' COMMENT '排序',
  `pgroup` int(10) DEFAULT '0' COMMENT '机组',
  `template` tinyint(1) DEFAULT '0' COMMENT '0:横版,1:竖版',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`id`),
  KEY `idx_day_id` (`day_id`, `status`),
  KEY `idx_title` (`title`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='单机推荐' ;

CREATE TABLE IF NOT EXISTS `game_single_banner` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  ...
  `img_high` varchar(255) NOT NULL DEFAULT '' COMMENT '高清图片',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='单机banner图' ;

CREATE TABLE IF NOT EXISTS `game_single_list_games` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_recommend_id` (`recommend_id`,`game_id`,`game_status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='游戏推荐' ;

CREATE TABLE IF NOT EXISTS `game_single_list_imgs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '图片ID',
  ...
  KEY `idx_link` (`link_type`,`link`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='推荐图片' ;

CREATE TABLE IF NOT EXISTS `game_single_list_alone` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `recommend_id` int(10) unsigned NOT NULL COMMENT '推荐id',
  `link_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '链接类型',
  `link` varchar(255) DEFAULT '' COMMENT '链接参数',
  ...
  KEY `idx_recommend_id` (`recommend_id`),
  KEY `idx_link` (`link_type`,`link`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='单独推荐' ;

CREATE TABLE IF NOT EXISTS `game_single_list_gift` (
  `id` int(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `recommend_id` int(10) unsigned NOT NULL COMMENT '推荐id',
  `gift_id` int(10) NOT NULL COMMENT '礼包ID',
  `gift_status` tinyint(1) DEFAULT '0' COMMENT '礼包状态',
  `sort` int(10) NOT NULL DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`),
  KEY `idx_recommend_id` (`recommend_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='礼包推荐' ;

CREATE TABLE IF NOT EXISTS `game_single_edit_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='编辑记录' ;


--create by luojiapeng
ALTER TABLE `game_sdk_ad` DROP COLUMN `temp_content`,
                          DROP COLUMN `is_add`,
                          DROP COLUMN `game_temp_ids`,
                          DROP COLUMN `is_finish`,
                          DROP column `ad_type`,
                          DROP column `game_num`,
                          ADD COLUMN `join_game_type` TINYINT(2) DEFAULT '1' NOT NULL COMMENT '0全部游戏，1定向，2排除';
-- Created By lichanghua@2015-08-18
ALTER TABLE `game_client_hd` ADD `hd_type` varchar(128) NOT NULL DEFAULT '0' AFTER `sort`;
INSERT INTO `game_config` (`game_key`, `game_value`) VALUES ('autoUpdateGame', '1');

--create by luojiapeng
UPDATE game_resource_attribute SET parent_id =1  WHERE id = 29;
UPDATE game_resource_attribute SET parent_id =2  WHERE id = 30;
UPDATE game_resource_attribute SET parent_id =3  WHERE id = 31;
UPDATE game_resource_attribute SET parent_id =4  WHERE id = 102;

ALTER TABLE `game_festivals_prizes` ADD `sort` int(11) NOT NULL DEFAULT 0  COMMENT '排序' after `prize_type`;
ALTER TABLE `game_festivals_props` ADD `gray_img` varchar(100) NOT NULL DEFAULT ''  COMMENT '灰色图片' after `img`;
ALTER TABLE `game_resource_imgs` ADD `type` tinyint(3) NOT NULL DEFAULT 0  COMMENT '720*1280截图' after `game_id`;

-----------------------------------------------1.6.0开始-----------------------------------
-- 新增人员: ChengYi, 2015.08.20
-- Mysql 注释: 关于栏目管理(新) 的表数据添加(1.6.0栏目的默认数据新增) - Start
-- 执行前注意`game_client_column_new`表数据中的 60 需要替换成 game_client_column_log 的最大自增ID
-- 
INSERT INTO `game_client_column_log` (`id`, `column_version`, `column_name`, `admin_id`, `admin_name`, `channel_num`, `column_num`, `create_time`, `update_time`, `status`, `start_time`, `step`, `is_deafault`, `temp1`, `temp2`, `temp3`) VALUES
(60, '1.6.0', '默认', 1, 'admin', 12, 5, '2015-07-01 01:21:41', 1413866150, 1, 1413803302, 4, 0, NULL, NULL, NULL);
ALTER TABLE `game_client_column_new` ADD `is_disabled` INT(1) UNSIGNED NOT NULL DEFAULT '0' AFTER `is_deafault`;
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `is_disabled`, `log_id`, `update_time`) VALUES
('2', 1, 4, '礼包', '', '', 0, '2015-01-28 19:32:34', 0, 1, 'giftlist', '', 2, '1.6.0', 0, 0, 60, 1422502533),
('2', 1, 2, '专题', '', '', 0, '2015-01-28 19:32:34', 0, 1, 'subjectlist', '', 2, '1.6.0', 0, 0, 60, 1422502533),
('4', 2, 3, '网游活跃榜', 'olactiveRank', '', 1, '2014-10-20 14:21:17', 0, 1, 'RankView', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('4', 2, 3, '游戏飙升榜', 'soaringRank', '', 1, '2014-10-20 14:21:17', 0, 1, 'RankView', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('3', 2, 6, '破解游戏', 'crackgame', '', 1, '2014-10-20 22:21:17', 0, 1, 'ListView', '', 3, '1.6.0', 0, 0, 60, 1413872580),
('4', 2, 3, '单机榜', 'pcRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('4', 2, 3, '网游榜', 'onlineRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('4', 2, 3, '上升最快', 'upRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('3', 2, 3, '新游榜', 'newRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('2', 1, 5, '活动频道', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'eventlist_sub', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('4', 1, 6, '单机游戏', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'pcgame', '', 3, '1.6.0', 0, 0, 60, 1413872580),
('3', 1, 6, '猜你喜欢', '', '', 0, '2014-10-20 22:21:17', 0, 1, 'glike', '', 3, '1.6.0', 0, 0, 60, 1413872580),
('2', 1, 6, '经典必玩', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'classic', '', 3, '1.6.0', 0, 0, 60, 1413872580),
('1', 1, 6, '新游尝鲜', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'newon', '', 3, '1.6.0', 0, 0, 60, 1413872580),
('1', 1, 5, '论坛', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'bbslist_sub', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('1', 1, 4, '热门', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'olghot', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('2', 1, 3, '月榜', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'rankmonth', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('1', 1, 3, '周榜', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'rankweek', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('1', 1, 2, '分类', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'categorylist', '', 2, '1.6.0', 0, 0, 60, 1413872580),
('1', 1, 1, '精选', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'chosen', '', 2, '1.6.0', 0, 1, 60, 1413872580),
('5', 1, 0, '论坛', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'bbslist', '', 1, '1.6.0', 0, 0, 60, 1413872580),
('4', 1, 0, '网游', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'olg', '', 1, '1.6.0', 0, 0, 60, 1413872580),
('3', 1, 0, '排行', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'rank', '', 1, '1.6.0', 0, 0, 60, 1413872580),
('2', 1, 0, '分类', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'category', '', 1, '1.6.0', 0, 0, 60, 1413872580),
('1', 1, 0, '首页', '', '', 1, '2014-10-20 22:21:17', 0, 1, 'home', '', 1, '1.6.0', 0, 0, 60, 1413872580);

--------------------------------------------NOTE：以上是v1.6.0--------------------------------------------------
---------------------v1.5.9-国庆活动-划屏游戏-----------------------
CREATE TABLE `game_touch_game_info`(
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(128) NOT NULL DEFAULT '' COMMENT '活动名称',
  `preheat_time` int(10) NOT NULL DEFAULT '0' COMMENT '预热时间',
  `preheat_config` text COMMENT '预热图片 json结构',
  `game_start_time` int(10) NOT NULL DEFAULT '0' COMMENT '游戏开始时间',
  `game_end_time` int(10) NOT NULL DEFAULT '0' COMMENT '游戏结束时间',
  `start_time` int(10) NOT NULL DEFAULT '0' COMMENT '活动开始时间',
  `end_time` int(10) NOT NULL DEFAULT '0' COMMENT '活动结束时间',
  `login_desc` text COMMENT '登录描述',
  `descript` text COMMENT '活动说明',
  `img_config` text COMMENT '活动图片配置 json 结构',
  `props_config` text COMMENT '活动道具配置 json 结构',
  `waring_config` text COMMENT '活动阀值配置 json 结构',
  `join` int(10) NOT NULL DEFAULT '0' COMMENT '参与人数',
  `times` int(10) NOT NULL DEFAULT '0' COMMENT '游戏次数',
  `points` int(10) NOT NULL DEFAULT '0' COMMENT '发放总积分',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:关闭 1:开启',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '活动添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='划屏游戏基础表';

CREATE TABLE `game_touch_game_total` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `info_id` int(10) NOT NULL DEFAULT '0' COMMENT '划屏游戏id',
  `uuid` varchar(128) NOT NULL DEFAULT '' COMMENT 'uuid',
  `uname` varchar(128) NOT NULL DEFAULT '' COMMENT '用户名',
  `times` int(10) NOT NULL DEFAULT '0' COMMENT '游戏次数',
  `score` int(10) NOT NULL DEFAULT '0' COMMENT '游戏最高分数',
  `points` int(10) NOT NULL DEFAULT '0' COMMENT '获得积分',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:无效 1:有效',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='划屏游戏用户表';

CREATE TABLE `game_touch_game_logs` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `info_id` int(10) NOT NULL DEFAULT '0' COMMENT '划屏游戏id',
  `uuid` varchar(128) NOT NULL DEFAULT '' COMMENT 'uuid',
  `uname` varchar(128) NOT NULL DEFAULT '' COMMENT '用户名',
  `score` int(10) NOT NULL DEFAULT '0' COMMENT '游戏分数',
  `points` int(10) NOT NULL DEFAULT '0' COMMENT '游戏积分',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='划屏游戏日志表';
------------------------------------------------------1.5.9结束---------------------------------------------------
-------------------------------------------------------
-- 新增人员: yinjy  2015-8-17
-- 作用： 活跃榜   飙升榜
-------------------------------------------------------
CREATE TABLE `dlv_game_dl_user_daily` (
  `day_id` int(11) NOT NULL COMMENT '日期(格式：yyyymmdd，如：20150608)',
  `game_id` int(11) NOT NULL COMMENT '游戏id',
  `dl_users` int(11) DEFAULT NULL COMMENT '下载用户数',
  PRIMARY KEY (`day_id`,`game_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='游戏下载表';

CREATE TABLE `dlv_game_online_game_active_daily` (
  `day_id` int(11) NOT NULL COMMENT '日期(格式：yyyymmdd，如：20150608)',
  `game_id` int(11) NOT NULL COMMENT '游戏id',
  `new_user` double(19,2) NOT NULL DEFAULT '0.00' COMMENT '新用户数',
  `act_user` double(19,2) NOT NULL DEFAULT '0.00' COMMENT '活跃用户数',
  PRIMARY KEY (`day_id`,`game_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='网游活跃表';

CREATE TABLE `dlv_game_rank_current_version` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `name` varchar(128) NOT NULL DEFAULT '' COMMENT '榜单名称',
  `current_version_id` varchar(128) NOT NULL DEFAULT '' COMMENT '当前版本id',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_name` (`name`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='游戏榜单当前版本保存表';

CREATE TABLE `dlv_game_rank_online_game_active` (
  `day_id` int(10) NOT NULL COMMENT '日期(格式：yyyymmdd，如：20150608)',
  `game_id` int(11) NOT NULL COMMENT '游戏id',
  `score` double(20,8) NOT NULL DEFAULT '0.00000000' COMMENT '得分',
  PRIMARY KEY (`day_id`,`game_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='网游活跃榜';

CREATE TABLE `dlv_game_rank_soaring` (
  `day_id` int(10) NOT NULL COMMENT '日期(格式：yyyymmdd，如：20150608)',
  `game_id` int(11) NOT NULL COMMENT '游戏id',
  `score` double(20,8) NOT NULL DEFAULT '0.00000000' COMMENT '得分',
  PRIMARY KEY (`day_id`,`game_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='游戏飙升榜';

INSERT INTO `dlv_game_rank_current_version` (`id`, `name`, `current_version_id`, `update_time`) VALUES (1, '游戏飙升榜', '20150705', '2015-7-7 10:01:15');
INSERT INTO `dlv_game_rank_current_version` (`id`, `name`, `current_version_id`, `update_time`) VALUES (2, '网游活跃榜', '20150706', '2015-7-8 20:31:25');


-------------------------------------------------------
-- 新增人员: ChengYi, 2015.07.31
-- 作用： 首页H5相关的数据表新增
-- list_resume: 单条活动/资讯的简介内容字段
-------------------------------------------------------
ALTER TABLE `game_h5_recommend_hdnew` ADD `list_resume` CHAR(200) NULL AFTER `list_title`;
ALTER TABLE `game_h5_recommend_hdnew_tmp` ADD `list_resume` CHAR(200) NULL AFTER `list_title`;

-------------------------------------------------------
-- 新增人员: ChengYi, 2015.07.29
-- 作用： 首页H5相关的数据表新增
-------------------------------------------------------

DROP TABLE IF EXISTS `game_h5_index_ad`;
CREATE TABLE `game_h5_index_ad` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `sort` int(10) DEFAULT NULL,
  `title` varchar(200) DEFAULT NULL,
  `button_on` int(1) DEFAULT NULL,
  `button_title` varchar(24) DEFAULT NULL,
  `button_url` mediumtext,
  `start_time` int(10) DEFAULT NULL,
  `end_time` int(10) DEFAULT NULL,
  `status` int(1) DEFAULT '1',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_首页浮动广告列表';

DROP TABLE IF EXISTS `game_h5_recommend`;
CREATE TABLE `game_h5_recommend` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  `content` varchar(255) DEFAULT NULL COMMENT '描述',
  ...
  KEY `title` (`title`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐集合';

DROP TABLE IF EXISTS `game_h5_recommend_banner`;
CREATE TABLE `game_h5_recommend_banner` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  `link_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '链接类型1:游戏内容2:外链',
  `link` varchar(255) DEFAULT '' COMMENT '链接参数',
  ...
  KEY `idx_sort` (`sort`),
  KEY `idx_link` (`link_type`,`link`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐banner图';

DROP TABLE IF EXISTS `game_h5_recommend_banner_tmp`;
CREATE TABLE `game_h5_recommend_banner_tmp` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tmp_id` int(11) unsigned NOT NULL COMMENT '临时ID',
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  `link_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '链接类型1:游戏内容2:外链',
  `link` varchar(255) DEFAULT '' COMMENT '链接参数',
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:无效,1:生效',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
  `maininit` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否转入主表',
  PRIMARY KEY (`id`),
  KEY `idx_day_id` (`day_id`),
  KEY `idx_status` (`status`),
  KEY `idx_sort` (`sort`),
  KEY `idx_link` (`link_type`,`link`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐banner图临时';

DROP TABLE IF EXISTS `game_h5_recommend_delete_tmp`;
CREATE TABLE `game_h5_recommend_delete_tmp` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tmp_id` int(11) unsigned NOT NULL COMMENT '临时ID',
  `delete_id` mediumtext NOT NULL COMMENT '数据库删除表名',
  `table_ismain` tinyint(1) unsigned NOT NULL COMMENT '是否是关联ID',
  `table_main_name` varchar(255) NOT NULL COMMENT '关联ID的字段名',
  `table_name` varchar(255) NOT NULL DEFAULT '' COMMENT '数据库表名',
  `maininit` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否转入主表',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_临时表删除操作记录';

DROP TABLE IF EXISTS `game_h5_recommend_edit_log`;
CREATE TABLE `game_h5_recommend_edit_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `day_id` int(10) NOT NULL COMMENT '天ID',
  `uid` int(10) NOT NULL DEFAULT '0' COMMENT '编辑人',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '编辑时间',
  PRIMARY KEY (`id`),
  KEY `idx_day_id` (`day_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_首页编辑记录';

DROP TABLE IF EXISTS `game_h5_recommend_games`;
CREATE TABLE `game_h5_recommend_games` (
  `recommend_id` varchar(255) NOT NULL DEFAULT '' COMMENT '主表ID',
  `game_id` int(10) NOT NULL DEFAULT '0' COMMENT '游戏ID',
  `sort` int(10) NOT NULL DEFAULT '0' COMMENT '排序',
  `game_status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '游戏状态',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_游戏推荐';

DROP TABLE IF EXISTS `game_h5_recommend_games_tmp`;
CREATE TABLE `game_h5_recommend_games_tmp` (
  `tmp_id` int(11) unsigned NOT NULL COMMENT '临时ID',
  `recommend_id` varchar(255) NOT NULL DEFAULT '' COMMENT '主表ID',
  `game_id` int(10) NOT NULL DEFAULT '0' COMMENT '游戏ID',
  `sort` int(10) NOT NULL DEFAULT '0' COMMENT '排序',
  ...
  PRIMARY KEY (`recommend_id`,`game_id`),
  KEY `idx_recoment_id_status` (`game_status`,`recommend_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_游戏推荐临时';

DROP TABLE IF EXISTS `game_h5_recommend_hdnew`;
CREATE TABLE `game_h5_recommend_hdnew` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `recommend_id` int(10) NOT NULL,
  `list_type` varchar(10) NOT NULL,
  `list_id` int(10) NOT NULL,
  `list_title` varchar(200) DEFAULT NULL,
  `list_sort` int(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_活动新闻列表';

DROP TABLE IF EXISTS `game_h5_recommend_hdnew_tmp`;
CREATE TABLE `game_h5_recommend_hdnew_tmp` (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `tmp_id` int(11) unsigned NOT NULL COMMENT '临时ID',
  `recommend_id` int(10) NOT NULL,
  `list_type` varchar(10) NOT NULL,
  ...
  PRIMARY KEY (`id`),
  KEY `idx_recommend_id` (`recommend_id`),
  KEY `idx_link` (`list_type`,`list_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_活动新闻列表临时';

DROP TABLE IF EXISTS `game_h5_recommend_imgs`;
CREATE TABLE `game_h5_recommend_imgs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '图片ID',
  `recommend_id` int(10) unsigned NOT NULL COMMENT '推荐id',
  `link_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '链接类型',
  `link` varchar(255) DEFAULT '' COMMENT '链接参数',
  ...
  KEY `idx_recommend_id` (`recommend_id`),
  KEY `idx_link` (`link_type`,`link`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐图片';

DROP TABLE IF EXISTS `game_h5_recommend_imgs_tmp`;
CREATE TABLE `game_h5_recommend_imgs_tmp` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '图片ID',
  `tmp_id` int(11) unsigned NOT NULL COMMENT '临时ID',
  `recommend_id` int(10) unsigned NOT NULL COMMENT '推荐id',
  `link_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '链接类型',
  ...
  KEY `idx_recommend_id` (`recommend_id`),
  KEY `idx_link` (`link_type`,`link`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐图片临时';


DROP TABLE IF EXISTS `game_h5_recommend_list`;
CREATE TABLE `game_h5_recommend_list` (
  `day_id` int(10) unsigned NOT NULL COMMENT 'ID',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`day_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐日程';

DROP TABLE IF EXISTS `game_h5_recommend_rank`;
CREATE TABLE `game_h5_recommend_rank` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `recommend_id` int(10) unsigned NOT NULL COMMENT '推荐id',
  `rank_type` char(20) NOT NULL COMMENT '链接类型',
  PRIMARY KEY (`id`),
  KEY `idx_recommend_id` (`recommend_id`),
  KEY `idx_rank_type` (`rank_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_排行榜';


DROP TABLE IF EXISTS `game_h5_recommend_rank_tmp`;
CREATE TABLE `game_h5_recommend_rank_tmp` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tmp_id` int(11) unsigned NOT NULL COMMENT '临时ID',
  `recommend_id` int(10) unsigned NOT NULL COMMENT '推荐id',
  `rank_type` char(20) NOT NULL COMMENT '链接类型',
  ...
  KEY `idx_recommend_id` (`recommend_id`),
  KEY `idx_rank_type` (`rank_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_排行榜临时';

DROP TABLE IF EXISTS `game_h5_recommend_tmp`;
CREATE TABLE `game_h5_recommend_tmp` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `tmp_id` int(11) unsigned NOT NULL COMMENT '临时ID',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  `content` varchar(255) DEFAULT NULL COMMENT '描述',
  ...
  KEY `end_time` (`end_time`),
  KEY `title` (`title`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='H5首页_推荐集合临时';

CREATE TABLE IF NOT EXISTS `asyn_task` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `task_id` varchar(100) NOT NULL COMMENT '任务ID',
  `task` varchar(100) NOT NULL DEFAULT '' COMMENT '任务',
  `method` varchar(50) NOT NULL DEFAULT '' COMMENT '执行方法',
  `args` varchar(255) NOT NULL DEFAULT '' COMMENT '参数',
  `start_time` int(10) NOT NULL DEFAULT '0' COMMENT '开始时间',
  `end_time` int(10) NOT NULL DEFAULT '0' COMMENT '结束时间',
  `use_time` int(10) NOT NULL DEFAULT '0' COMMENT '耗时(毫秒)',
  `result` smallint(4) NOT NULL DEFAULT '0' COMMENT '执行结果',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='异步任务' ;

CREATE TABLE IF NOT EXISTS `asyn_task_spl` (
  `id` bigint(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `task_id` varchar(100) NOT NULL COMMENT '任务id',
  `subject` varchar(100) NOT NULL DEFAULT '' COMMENT '主题',
  `observer` varchar(100) NOT NULL DEFAULT '' COMMENT '观察者',
  `args` varchar(255) NOT NULL DEFAULT '' COMMENT '参数',
  `result` tinyint(1) NOT NULL DEFAULT '0' COMMENT '执行结果',
  `use_time` int(10) NOT NULL DEFAULT '0' COMMENT '耗时(毫秒)',
  PRIMARY KEY (`id`),
  KEY `task_id` (`task_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='异步观察者' ;

ALTER TABLE `game_client_gift_log` ADD `log_type` tinyint(1) NOT NULL DEFAULT '0'  COMMENT '0:抢礼包,1:送礼包' after id;
CREATE TABLE IF NOT EXISTS `game_client_navigation` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `module` char(50) NOT NULL DEFAULT '' COMMENT '模块',
  `title` varchar(20) NOT NULL DEFAULT '' COMMENT '标题',
  `view_type` varchar(50) NOT NULL DEFAULT '' COMMENT '显示窗口',
  `icon_url` varchar(255) NOT NULL DEFAULT '' COMMENT '图标',
  `param` varchar(300) NOT NULL DEFAULT '' COMMENT '客户端参数',
  `sort` tinyint(1) NOT NULL DEFAULT '0' COMMENT '排序',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '状态',
  PRIMARY KEY (`id`),
  KEY `module` (`module`,`status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='客户端按钮导航' ;

INSERT INTO `game_client_navigation` (`id`, `module`, `title`, `view_type`, `icon_url`, `param`, `sort`, `status`) VALUES 
(1, 'WEB_GAME', '开服信息', 'ServiceInfoView', '', '{"url":"http://game.gionee.com/Api/Local_Webgame/openList?page=","title":"开服信息"}', 3, 0),
(2, 'WEB_GAME', '网游分类', 'CategoryDetailView', '', '{"contentId":"32","title":"网游分类"}', 2, 1),
(3, 'WEB_GAME', '热门礼包', 'GiftListView', '', '{"title":"热门礼包"}', 1, 1);
...
CREATE TABLE IF NOT EXISTS `game_open` (
  ...
  `open_type` int(4) NOT NULL DEFAULT '0' COMMENT '1:新服,2:合服',
  `open_time` int(10) NOT NULL COMMENT '开服时间',
  `update_time` int(10) NOT NULL COMMENT '同步时间',
  `status` tinyint(1) DEFAULT '1' COMMENT '0:无效,1:有效',
  `game_status` tinyint(1) DEFAULT '1' COMMENT '游戏状态',
  PRIMARY KEY (`id`),
  KEY `idx_game_id` (`game_id`),
  KEY `idx_open_time` (`open_time`),
  KEY `idx_status` (`status`,`game_status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='开服列表' ;

CREATE TABLE IF NOT EXISTS `game_web_rec` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  `content` varchar(255) DEFAULT NULL COMMENT '描述',
  `day_id` int(10) NOT NULL DEFAULT '0' COMMENT '生效日期',
  `rec_type` tinyint(1) DEFAULT '0' COMMENT '0:合集,1:图片,2:礼包,3:开服',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:关闭,1:开启',
  `sort` tinyint(1) NOT NULL DEFAULT '0' COMMENT '排序',
  `pgroup` int(10) DEFAULT '0' COMMENT '机组',
  `template` tinyint(1) DEFAULT '0' COMMENT '0:横版,1:竖版',
  ...
  KEY `idx_day_id` (`day_id`, `status`),
  KEY `idx_title` (`title`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='网游推荐' AUTO_INCREMENT=1 ;

CREATE TABLE IF NOT EXISTS `game_web_recommend` (
  `day_id` int(10) unsigned NOT NULL COMMENT 'ID',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
  PRIMARY KEY (`day_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='网游推荐信息';

CREATE TABLE IF NOT EXISTS `game_web_rec_banner` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `sort` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '排序',
  `title` varchar(255) NOT NULL DEFAULT '' COMMENT '标题',
  `link_type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '链接类型',
  ...
  KEY `idx_day_id` (`day_id`, `status`),
  KEY `idx_link` (`link_type`,`link`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='网游banner图' AUTO_INCREMENT=1 ;

CREATE TABLE IF NOT EXISTS `game_web_rec_edit_log` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `day_id` int(10) NOT NULL COMMENT '天ID',
  `uid` int(10) NOT NULL DEFAULT '0' COMMENT '编辑人',
  `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '编辑时间',
  PRIMARY KEY (`id`),
  KEY `idx_day_id` (`day_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='编辑记录' AUTO_INCREMENT=1 ;

CREATE TABLE IF NOT EXISTS `game_web_rec_games` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '图片ID',
  `recommend_id` varchar(255) NOT NULL DEFAULT '' COMMENT '主表ID',
  `game_id` int(10) NOT NULL DEFAULT '0' COMMENT '游戏ID',
  `sort` int(10) NOT NULL DEFAULT '0' COMMENT '排序',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_recommend_id` (`recommend_id`,`game_id`,`game_status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='游戏推荐' AUTO_INCREMENT=1 ;

CREATE TABLE IF NOT EXISTS `game_web_rec_imgs` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '图片ID',
  `recommend_id` int(10) unsigned NOT NULL COMMENT '推荐id',
  `link_type` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '链接类型',
  `link` varchar(255) DEFAULT '' COMMENT '链接参数',
...
CREATE TABLE IF NOT EXISTS `game_web_rec_open` (
  `id` int(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `recommend_id` int(10) unsigned NOT NULL COMMENT '推荐id',
  `open_id` int(10) NOT NULL COMMENT '开服ID',
  `open_status` tinyint(1) DEFAULT '1' COMMENT '0:无效,1:有效',
  `sort` int(10) NOT NULL DEFAULT '0' COMMENT '排序',
  PRIMARY KEY (`id`),
  KEY `idx_recommend_id` (`recommend_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='开服信息' AUTO_INCREMENT=1 ;

ALTER TABLE `game_recommend` ADD `list_tpl` TINYINT( 1 ) NULL DEFAULT '0' COMMENT '0:横版,1:竖版' AFTER `day_id` ;

-- 手动发送a券赠送原因log
-- Created By fanch@2015-07-07
DROP TABLE IF EXISTS `game_client_sendticket_reason`;
CREATE TABLE `game_client_sendticket_reason` (
   `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
   `aid` varchar(255) NOT NULL DEFAULT '' COMMENT ' A券的id ',
   `reason` text DEFAULT '' COMMENT 'A券发放原因',
...
ALTER TABLE `game_mall_goods` ADD `discountArr` text COMMENT '折扣信息' after consume_point;
ALTER TABLE `game_mall_goods` ADD `descrip` text NOT NULL  COMMENT '商品描述' after title;
--积分抽奖表结构修改
ALTER TABLE `game_point_prize` ADD `type` tinyint(1) NOT NULL DEFAULT '0' AFTER `img`;
ALTER TABLE `game_point_prize_config` ADD `sub_type` tinyint(1) NOT NULL DEFAULT '0' AFTER `type`;
ALTER TABLE `game_point_prize_config` ADD `sub_amount` int(10) NOT NULL DEFAULT '0' AFTER `sub_type`;
ALTER TABLE `game_point_prize_config` ADD `small_img` varchar(100) NOT NULL DEFAULT '' AFTER `day`;
ALTER TABLE `game_point_prize_config` ADD `max_times` int(10) NOT NULL DEFAULT 0 AFTER `max_win`;
-- 积分抽奖黑名单
-- Created By fanch@2015-07-07
DROP TABLE IF EXISTS `game_point_prize_blacklist`;
CREATE TABLE `game_point_prize_blacklist` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_uuid` (`uuid`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='积分抽奖黑名单';
...
-- 50,1,2 需要替换成 ‘game_client_column_log’ 对应版本的[默认]条目的ID
-- 
...
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('1', 1, 0, '首页', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'home', '', 1, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('2', 1, 0, '分类', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'category', '', 1, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('3', 1, 0, '排行', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'rank', '', 1, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('4', 1, 0, '网游', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'olg', '', 1, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('5', 1, 0, '论坛', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'bbslist', '', 1, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('1', 1, 1, '精选', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'chosen', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('1', 1, 2, '分类', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'categorylist', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('1', 1, 3, '周榜', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'rankweek', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('2', 1, 3, '月榜', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'rankmonth', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('1', 1, 4, '热门', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'olghot', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('1', 1, 5, '论坛', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'bbslist_sub', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('1', 1, 6, '新游尝鲜', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'newon', '', 3, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('2', 1, 6, '经典必玩', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'classic', '', 3, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('3', 1, 6, '猜你喜欢', '', '', 0, '2014-10-21 06:21:17', 0, 1, 'glike', '', 3, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('4', 1, 6, '单机游戏', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'pcgame', '', 3, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('2', 1, 5, '活动频道', '', '', 1, '2014-10-21 06:21:17', 0, 1, 'eventlist_sub', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('3', 2, 3, '新游榜', 'newRank', '', 1, '2014-10-21 06:21:17', 0, 1, 'RankView', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('4', 2, 3, '上升最快', 'upRank', '', 1, '2014-10-21 06:21:17', 0, 1, 'RankView', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('4', 2, 3, '网游榜', 'onlineRank', '', 1, '2014-10-21 06:21:17', 0, 1, 'RankView', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('4', 2, 3, '单机榜', 'pcRank', '', 1, '2014-10-21 06:21:17', 0, 1, 'RankView', '', 2, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES('3', 2, 6, '破解游戏', 'crackgame', '', 1, '2014-10-21 06:21:17', 0, 1, 'ListView', '', 3, '1.5.9', 0, 52, 1413872580);
INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES
('4', 2, 3, '游戏飙升榜', 'soaringRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.5.9', 0, 52, 1413872580),
('4', 2, 3, '网游活跃榜', 'olactiveRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.5.9', 0, 52, 1413872580);

INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES
('2', 1, 2, '专题', '', '', 0, '2015-01-29 03:32:34', 0, 1, 'subjectlist', '', 2, '1.5.9', 0, 52, 1422502533),
('2', 1, 4, '礼包', '', '', 0, '2015-01-29 03:32:34', 0, 1, 'giftlist', '', 2, '1.5.9', 0, 52, 1422502533);

INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES
('4', 2, 3, '游戏飙升榜', 'soaringRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.5.8', 0, 50, 1413872580),
('4', 2, 3, '网游活跃榜', 'olactiveRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.5.8', 0, 50, 1413872580);

INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES
('4', 2, 3, '游戏飙升榜', 'soaringRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.5.3', 0, 2, 1413872580),
('4', 2, 3, '网游活跃榜', 'olactiveRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.5.3', 0, 2, 1413872580);

INSERT INTO `game_client_column_new` (`position`, `channel_type`, `pid`, `name`, `link`, `icon_choose`, `status`, `create_time`, `default_open`, `show_type`, `relevance`, `icon_default`, `level`, `column_version`, `is_deafault`, `log_id`, `update_time`) VALUES
('4', 2, 3, '游戏飙升榜', 'soaringRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.5.2', 0, 1, 1413872580),
('4', 2, 3, '网游活跃榜', 'olactiveRank', '', 1, '2014-10-20 22:21:17', 0, 1, 'RankView', '', 2, '1.5.2', 0, 1, 1413872580);
--
...
-- 【配置】游戏大厅活动配置
CREATE TABLE IF NOT EXISTS `game_activity_cfg` (
    `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `activity_type` int(10) NOT NULL DEFAULT '0' COMMENT '0:2015版本暑假任务',
    `name` varchar(255) NOT NULL DEFAULT '' COMMENT '活动名称',
    `preheat_time` int(10) NOT NULL DEFAULT '0' COMMENT '预热时间',
    `preheat_img` varchar(50) DEFAULT '' COMMENT  '预热图片',
    `start_time` int(10) NOT NULL DEFAULT '0' COMMENT '生效开始时间',
    `end_time` int(10) NOT NULL DEFAULT '0' COMMENT '生效结束时间',
    `img` varchar(50) DEFAULT '' COMMENT  '活动图片',
    `explain` text COMMENT '说明',
    `client_version` text COMMENT '游戏大厅版本',
    `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '0:关闭 1:开启',
    `activity` text COMMENT '任务配置。json格式，activity_type不同，activity的格式可能不同',
    `reward` text COMMENT '奖励配置，json格式，activity_type不同，reward的格式可能不同',
    PRIMARY KEY (`id`),
    KEY `idx_activity_type` (`activity_type`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8  COMMENT='游戏大厅活动配置';

-- 【数据】用户参与活动的数据
CREATE TABLE IF NOT EXISTS `game_activity_user_data` (
    `id` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID',
    `activity_id` int(10) NOT NULL DEFAULT '0' COMMENT '活动id',    
    `uuid` varchar(50) DEFAULT '' COMMENT  'uuid',
    `data` text COMMENT '参与活动的数据, 不同活动，data格式可能不同',
    PRIMARY KEY (`id`),
    KEY `idx_activity_id` (`activity_id`),
    UNIQUE KEY `idx_aid_uuid` (`activity_id`, `uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8  COMMENT='用户参与活动的数据';
...
CREATE TABLE IF NOT EXISTS `game_activity_reward_log` (
    ...
    `create_time` int(10) NOT NULL DEFAULT '0' COMMENT '创建时间',
    `custom_key` varchar(50) NOT NULL DEFAULT '0' COMMENT '自定义key，用于做同类型奖励统计用',
    `custom_count` int(10) NOT NULL DEFAULT '0' COMMENT '自定义value，用于统计用',
    `reward` text COMMENT '奖励详细信息',
    PRIMARY KEY (`id`),
    KEY `idx_activity_id` (`activity_id`),
    KEY `idx_aid_uuid` (`activity_id`, `uuid`),
    KEY `idx_custom_key` (`custom_key`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户奖励发放记录';

---------------------------------- [END] create by zhengzw ----------------------------------
...
-- Created By zhengzw@2015-06-29
 ...
 ALTER TABLE `idx_game_resource_version` 
   ADD COLUMN `file_size` BIGINT(10) UNSIGNED DEFAULT '0' NOT NULL ;
      
ALTER TABLE `idx_game_diff_package` 
   ADD COLUMN `file_size` BIGINT(10) UNSIGNED DEFAULT '0' NOT NULL ;
...
CREATE TABLE `game_user_points_gain` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `uuid` VARCHAR(50) NOT NULL DEFAULT '',
  `gain_type` TINYINT(3) NOT NULL DEFAULT '0' COMMENT '获取的途径类型 1福利任务  2 日常任务 3活动任务 4 手动发送 5抽奖获取 6商城兑换 7用户赠送 8 节日活动赠送 9 暑假活动 10 划屏游戏' ,
...
-- Fields condition_value          赠送条件的值【htype =3并且condition_type = 2,3,4的时候该字段才有值 htype =4 并且condition_type = 4,7的时候该字段才有值】
...
CREATE TABLE `game_client_ticket_trade` (
  ...
  `send_type` tinyint(2) NOT NULL DEFAULT '0' COMMENT '发放的类型 1 福利任务 2每日任务 3活动 4 手动发送 5抽奖获取 6商城兑换 7用户赠送 8节日活动',
