 ...
 *
 */
class Client_Ad_ChannelController extends Admin_BaseController {
	
	public $actions = array(
		'listUrl' => '/Admin/Client_Ad_Channel/index',
		'addUrl' => '/Admin/Client_Ad_Channel/add',
		'addPostUrl' => '/Admin/Client_Ad_Channel/add_post',
		'editUrl' => '/Admin/Client_Ad_Channel/edit',
		'editPostUrl' => '/Admin/Client_Ad_Channel/edit_post',
		'deleteUrl' => '/Admin/Client_Ad_Channel/delete',
		'uploadUrl' => '/Admin/Client_Ad_Channel/upload',
		'uploadPostUrl' => '/Admin/Client_Ad_Channel/upload_post',
	...
	private function _cookData($info) {
		...
		if(!$info['icon']) $this->output(-1, '广告图标不能为空.');
