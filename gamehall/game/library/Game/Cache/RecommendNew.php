...
/**
 * 
 * Game_Cache_RecommendNew
 * @author wupeng
 *
 */
class Game_Cache_RecommendNew extends Cache_Base{
	public $expire = 86400;
	private $dataList;
	private $controll;
	private $api;
	...
	public function __construct() {
	    $this->api = Util_CacheKey::getApi(Util_CacheKey::HOME, Util_CacheKey::HOME_LIST);
	...
	public static function getInstance() {
	    if(! self::$instance) {
	        self::$instance = new Game_Cache_RecommendNew();
	    }
