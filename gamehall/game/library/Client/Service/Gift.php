...
class Client_Service_Gift extends Common_Service_Base{
	...
	public static function getGiftListKeyName($page, $gameId = 0, $versionData) {
		$dataKeyName = Util_CacheKey::GIFT . '::' . Util_CacheKey::GIFT_LIST.'_'.$page.'_'.$gameId.'_'.$versionData;
		return $dataKeyName;
	}
	...
	public static function getGiftListKeyNameForNew($page, $versionData) {
		$dataKeyName = Util_CacheKey::GIFT . '::' . Util_CacheKey::GAME_GIFT_LIST.'_'.$page.'_'.$versionData;
		return $dataKeyName;
	}
