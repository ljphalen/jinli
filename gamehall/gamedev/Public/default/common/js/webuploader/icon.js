...
jQuery(function() {
    ...
    var copyright_upload_init = function(_id) {
        ...
        uploader.on( 'uploadSuccess', function( file, data ) {
            ...
            if(data.picurl) {
				$(".deletecprBtn").show();
            	$("#copyrightUploadImg").attr("src",data.picurl).show();
            }
        });
...
//应用上传版权证书可删除重新上传
$(".deletecprBtn").click(function(){
	$(this).hide();
	$("#copyrightUploadImg").attr("src", $("#copyrightUploadImg").attr("default"));
	$.ajax({
		"type":"GET",
		"url":"/Picture/del_copyright?apk_id="+$(this).attr("apk_id")+"&apk_id="+$(this).attr("app_id")
	});
})
