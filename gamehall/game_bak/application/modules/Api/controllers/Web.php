 ...
 *
 */
class WebController extends Api_BaseController{
	...
	public function indexAction(){
		...
		foreach($games as $key=>$value) {
			...
			$data = array(
						...
						'resume'=>$value['resume'],
						'size'=>$value['size'].'M',
						'link'=>Common::tjurl($webroot. '/client/index/tj', $value['id'], $src, $value['link']),
						'alink'=>urldecode($webroot. '/client/index/detail/?id=' . $value['id'].'&pc=1&intersrc='.$src.'&t_bi='.$this->getSource()),
