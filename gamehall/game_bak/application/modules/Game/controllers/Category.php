...
class CategoryController extends Game_BaseController{
	...
	public function indexAction() {
	    ...
	    //游戏分类
		list($total, $categorys) = Resource_Service_Attribute::getList(1, 8, array('at_type'=>1, 'parent_id'=>0, 'status'=>1), array('sort'=>'DESC'));
		//客户端
   ...
   /**
	...
	public function moreAction() {
		...
		if ($page < 1) $page = 1;
		//游戏分类
		list($total, $categorys) = Resource_Service_Attribute::getList($page, 8, array('at_type'=>1, 'parent_id'=>0, 'status'=>1), array('sort'=>'DESC'));
	...
	public function detailAction(){
		...
		if($id == '100'){              //所有分类
			...
			$gameAttr = Resource_Service_Attribute::getBy(array('id'=>$id));
