...
$lock = $cache->get(Util_CacheKey::LOCK_FREE_DOWNLOAD_SYNC_STATE);
if($lock) exit("nothing to do.\n");
$cache->set(Util_CacheKey::LOCK_FREE_DOWNLOAD_SYNC_STATE, 1, 11*60); //11分钟过期
...
$cache->set(Util_CacheKey::LOCK_FREE_DOWNLOAD_SYNC_STATE, 0, 11*60); //11分钟过期
exit;
