...
<head>
	<meta charset="utf-8">
	<title>金立世界-手机配件</title>
	<?php include '_inc.php';?>
</head>
<body>
	<div id="page">
		<?php $page = '1-3'; include '_header.php';?>
					...
					<?php for($i = 0; $i < 6; $i++):?>
						<li>
							<a href="http://www.baidu.com">
								<dl>
									<dt>
										<div class="pic"><img src="http://vkassets.sinaapp.com/apps/browser/v1.1/pic/pic_newsImg.jpg" alt="" /></div>
									</dt>
									<dd class="l-line">
										<h2>sdfsdafdsa</h2>
							...
							<div class="extra"><sup class="supText">￥</sup><span class="price">35</span></div>
						</li>
					<?php endfor; ?>
					</ul>
				</div>
